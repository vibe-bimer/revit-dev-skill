...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.htm) Autodesk.Revit.DBDatumPlane [Autodesk.Revit.DBGrid](47888507-2d69-664a-ead4-e481c7c5f42d.htm) [Autodesk.Revit.DBLevel](577e5d4e-a558-118c-9dea-3b810b061775.htm) [Autodesk.Revit.DBReferencePlane](e7003ec7-1dbe-50a2-fb3d-a83a5a3b5b9f.htm)
...
| Name| Description  
---|---|---  
![Public method](../icons/pubMethod.gif)| [AddLeader](0373eec6-5963-b036-e816-de4d93f2f5f1.htm)|  Adds a default Leader for the indicated end of the datum plane. This method does not apply to Reference planes (which do not support leaders).   
...
![Public method](../icons/pubMethod.gif)| [CanBeVisibleInView](88545b41-8cd2-521a-748c-94967a66dc72.htm)|  Checks if the datum plane can be visible in the view.   
...
![Public method](../icons/pubMethod.gif)| [GetCurvesInView](2f93dd88-baac-8e61-377e-b937f3faaff6.htm)|  Gets a collection of curves representing the DatumPlane element in the given view.   
![Public method](../icons/pubMethod.gif)| [GetDatumExtentTypeInView](b3498ccf-1180-e0fd-502c-6c767f5b42cc.htm)|  Identifies whether the curve representing the datum plane is displayed according to its actual 3d extents, or else according to a view specific setting.   
...
![Public method](../icons/pubMethod.gif)| [GetLeader](4f5ebf97-8a85-bd5b-0edd-f2f0f6b18cb2.htm)|  Gets a copy of the leader applied to the indicated end of the datum plane. This method does not apply to Reference planes (which do not support leaders).   
...
![Public method](../icons/pubMethod.gif)| [GetPropagationViews](ecfed956-7434-0c33-6ab0-0bc80bd2a157.htm)|  Gets a list of candidate views which are parallel to the current view and to which the extents of the datum may be propagated.   
...
![Public method](../icons/pubMethod.gif)| [HasBubbleInView](c216fb35-eb3b-6097-e866-989dfb1d433e.htm)|  Identifies if the DatumPlane has bubble or not.   
...
![Public method](../icons/pubMethod.gif)| [HideBubbleInView](1349dc55-fbac-f114-f94d-42fc5fc10b1f.htm)|  Hides the bubble in a view. This method does not apply to Reference planes.   
![Public method](../icons/pubMethod.gif)| [IsBubbleVisibleInView](75c39be6-5f78-9dd2-061e-13b846e739d5.htm)|  Identifies if the bubble is visible or not in a view.   
...
![Public method](../icons/pubMethod.gif)| [IsCurveValidInView](2fb3c757-0555-d2ba-2cd2-9399bf238735.htm)|  Checks if the curve is valid to be as the extents for the datum plane in a view. The curve must be bound and coincident with the original one of the datum plane.   
...
![Public method](../icons/pubMethod.gif)| [IsLeaderValid](321a1f1a-61ef-3e7a-e87a-47d4cd4fd014.htm)|  Identifies if the leader valid or not for this DatumPlane. This method does not apply to Reference planes (which do not support leaders).   
...
![Public method](../icons/pubMethod.gif)| [Maximize3DExtents](231447e9-0963-fe1d-8177-d8ac136f835d.htm)|  Computes the 3d extents of all model geometry and levels, and extends the 3d extents of this datum surface to include the model extents.   
![Public method](../icons/pubMethod.gif)| [PropagateToViews](4512810a-93c3-d127-6197-94da427d54a2.htm)|   
...
![Public method](../icons/pubMethod.gif)| [SetCurveInView](eaff0038-34f2-03cf-185b-2872cffb84af.htm)|  Sets the extents to match the curve.   
![Public method](../icons/pubMethod.gif)| [SetDatumExtentType](6509627e-dda7-4d3d-eddf-4ed462a1f68c.htm)|  Sets whether the curve representing the datum plane is displayed according to its 3d extents, or else according to a view specific setting.   
...
![Public method](../icons/pubMethod.gif)| [SetLeader](a771f300-9d74-3ed7-ba1b-b0961e6c36b3.htm)|  Sets the leader to the indicated end of the datum plane. This method does not apply to Reference planes (which do not support leaders).   
![Public method](../icons/pubMethod.gif)| [ShowBubbleInView](e8bbbf7f-38d2-d818-1738-17d844b96162.htm)|  Shows the bubble in a view. This method does not apply to Reference planes.   
