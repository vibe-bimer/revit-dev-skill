...
---  
Analytical space. 
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.htm) Autodesk.Revit.DB.AnalysisEnergyAnalysisSpace
...
| Name| Description  
---|---|---  
![Public property](../icons/pubProperty.gif)| [Area](48a1a8b2-aba4-2c2b-a034-aa6ff514f70d.htm)|  The area for this space.   
...
![Public property](../icons/pubProperty.gif)| [CADObjectUniqueId](9389805f-ff4c-078b-d79f-1736b0dc3f99.htm)|  The unique id of the originating CAD object (model element) associated with this space.   
...
![Public property](../icons/pubProperty.gif)| [ComposedName](dc4bb53e-1f1a-ceeb-2875-4595296dce8a.htm)|  The composed name for this space.   
...
![Public property](../icons/pubProperty.gif)| [Description](393dee9c-00a3-17cd-174a-5fc659a16157.htm)|  The description.   
...
![Public property](../icons/pubProperty.gif)| [Number](cff842c6-97e2-7728-c1a5-3fd25bddf1a6.htm)|  The number to identify the space.   
...
![Public property](../icons/pubProperty.gif)| [SpaceName](e35fda64-158d-c86b-95e8-d2f212780443.htm)|  The name.   
...
![Public property](../icons/pubProperty.gif)| [Volume](36257f80-cd3d-c85d-8e9d-af6c298fee77.htm)|  The volume for this space.   
...
![Public method](../icons/pubMethod.gif)| [GetAnalyticalSurfaces](ed3a5d9b-8fbc-b17f-df57-6fc1033cb491.htm)|  Provides a way to access the collection of analytical surfaces for a space. Geometry data defining an analytical space volume. Through an analytical surface you can connect a source element with each polygon in a space. The analytical surfaces defines an enclosed volume bounded by the center plane of walls and the top plane of roofs and floors.   
![Public method](../icons/pubMethod.gif)| [GetBoundary](34f9d5ec-7195-0324-60a4-a2d51d8b2ab8.htm)|  Gets the collection of polygons that form the 2D boundary. This method returns a collection of polyloops (planar polygons) that defines an enclosed area measured by interior bounding surfaces, if in rooms and spaces mode. In other modes, returns no polyloops.   
![Public method](../icons/pubMethod.gif)| [GetClosedShell](58410893-1269-98e3-7a07-e5dacafbc9fe.htm)|  Gets the collection of polygons that form a closed shell. This method returns a collection of polyloops (planar polygons) that defines an enclosed volume measured by interior bounding surfaces, if in rooms and spaces mode. In other modes, returns no polyloops.   
