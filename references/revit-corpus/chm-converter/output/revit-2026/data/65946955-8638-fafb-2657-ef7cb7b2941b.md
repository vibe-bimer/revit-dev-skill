...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.htm) Autodesk.Revit.DBMEPSystem [Autodesk.Revit.DB.ElectricalElectricalSystem](158b4be3-bbe5-11eb-cccc-788edd3a7590.htm) [Autodesk.Revit.DB.MechanicalMechanicalSystem](ef83dd58-07d6-4f9a-8dc6-f4b1fd8246d2.htm) [Autodesk.Revit.DB.PlumbingPipingSystem](6abbdfa2-69a5-eef1-2663-89a5faf91831.htm)
...
![Public property](../icons/pubProperty.gif)| [BaseEquipment](00d90c4f-1946-1069-7887-f12899846481.htm)| The base panel or equipment of the system.  
![Public property](../icons/pubProperty.gif)| [BaseEquipmentConnector](ba498d21-cdd8-ef07-e906-410443befc47.htm)| The connector within base equipment which is used to connect with system.  
...
![Public property](../icons/pubProperty.gif)| [ConnectorManager](891c572c-e7de-8593-330d-5afc8aed9e63.htm)| Connector manager of the system.  
...
![Public property](../icons/pubProperty.gif)| [Elements](c1cb0808-3b81-87a5-b804-84a733686f2d.htm)| Terminal elements in the system.  
...
![Public property](../icons/pubProperty.gif)| [HasDesignParts](2eeb83d4-64d1-a6b7-9116-9b687037406a.htm)|  Indicates if the system has one or more design parts.   
![Public property](../icons/pubProperty.gif)| [HasFabricationParts](1d649db3-79da-5cf7-5224-1dd689240afa.htm)|  Indicates if the system has one or more fabrication parts.   
![Public property](../icons/pubProperty.gif)| [HasPlaceholders](e89c9b10-e8d5-5cda-5190-94ac03b704fe.htm)|  Indicates if the system has one or more placeholders.   
...
![Public property](../icons/pubProperty.gif)| [IsEmpty](3c5bb767-5e7a-0080-45e9-c16b161a0e10.htm)|  Indicates if the system is empty or not.   
...
![Public property](../icons/pubProperty.gif)| [IsMultipleNetwork](dce222a6-f12a-5db6-8ebb-84ac1ecf57f0.htm)|  Indicates if the system is well connected or not. The flag will enable the "Divide System" button.   
...
![Public property](../icons/pubProperty.gif)| [IsValid](700f2642-f813-1955-d3c3-8bb99ac1b125.htm)|  Indicates if the system is valid or not. atom AtomValidateSystem default false   
...
![Public property](../icons/pubProperty.gif)| [PressureLossOfCriticalPath](d44592e9-ab39-2d59-5872-0c58885839dd.htm)|  The total pressure loss of the sections in critical path.   
![Public property](../icons/pubProperty.gif)| [SectionsCount](530f3786-cac3-01c6-8ba8-7bccab7d3d49.htm)|  The number of sections.   
...
| Name| Description  
---|---|---  
![Public method](../icons/pubMethod.gif)| [Add](f40dba23-b703-6a37-0e09-7dfcd2eb1955.htm)|  Add elements into the system and connect them with the system using given connectors.   
...
![Public method](../icons/pubMethod.gif)| [DivideSystem](1bb1e7d5-a9f6-0c2d-e413-064bd4aa2c02.htm)|  Divide the phyisical networks in the system and create a new system for each network.   
...
![Public method](../icons/pubMethod.gif)| [GetCriticalPathSectionNumbers](b68ff5b9-e8cf-2565-2b50-03a8d2489ac3.htm)|  Obtains a list of the critical path section numbers.   
...
![Public method](../icons/pubMethod.gif)| [GetPhysicalNetworksNumber](23ca7db4-fa65-1149-95d7-9f17b80e073a.htm)|  Get the physical networks number in the system.   
![Public method](../icons/pubMethod.gif)| [GetSectionByIndex](dd53cbe2-37e6-19a1-e627-74a2aacb3433.htm)|  Get the section from the index.   
![Public method](../icons/pubMethod.gif)| [GetSectionByNumber](11cc783a-32f8-b0e0-2da6-5ecc6b9e57a6.htm)|  Get the Section from section number   
...
![Public method](../icons/pubMethod.gif)| [IsSystemDividable](4764bc4f-7ca7-820e-2b06-ac1a25750971.htm)|  Checks if the system is dividable. The system is dividable if there is more than one physical network in the system. Currently, only HVAC and piping systems support dividing.   
