...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.htm) [Autodesk.Revit.DBDatumPlane](3e0a6725-ee40-c4d5-839f-b7720c1fe2af.htm) Autodesk.Revit.DBLevel
...
![Public property](../icons/pubProperty.gif)| [Elevation](b5d48a18-4aa9-7457-7a6a-6d4966eaf77f.htm)|  Retrieves or changes the elevation above or below the ground level.   
...
![Public property](../icons/pubProperty.gif)| [ProjectElevation](895ef506-bfea-cc4e-31f8-aad2af6672e4.htm)|  Retrieves the elevation relative to project origin, no matter what values of the Elevation Base parameter is set.   
...
| Name| Description  
---|---|---  
![Public method](../icons/pubMethod.gif)| [AddLeader](0373eec6-5963-b036-e816-de4d93f2f5f1.htm)|  Adds a default Leader for the indicated end of the datum plane. This method does not apply to Reference planes (which do not support leaders). (Inherited from [DatumPlane](3e0a6725-ee40-c4d5-839f-b7720c1fe2af.htm))  
...
![Public method](../icons/pubMethod.gif)| [CanBeVisibleInView](88545b41-8cd2-521a-748c-94967a66dc72.htm)|  Checks if the datum plane can be visible in the view. (Inherited from [DatumPlane](3e0a6725-ee40-c4d5-839f-b7720c1fe2af.htm))  
...
![Public method](../icons/pubMethod.gif)![Static member](../icons/Static.gif)| [Create](d661b7cd-dec8-6ae6-a753-b14ac2568772.htm)|  Creates a new instance of level based on an input elevation.   
...
![Public method](../icons/pubMethod.gif)| [FindAssociatedPlanViewId](ff23277a-3bb1-253d-e158-983b23aaf04a.htm)|  Finds the id of the first available associated floor or structural plan view associated with this level.   
![Public method](../icons/pubMethod.gif)| [GetCurvesInView](2f93dd88-baac-8e61-377e-b937f3faaff6.htm)|  Gets a collection of curves representing the DatumPlane element in the given view. (Inherited from [DatumPlane](3e0a6725-ee40-c4d5-839f-b7720c1fe2af.htm))  
![Public method](../icons/pubMethod.gif)| [GetDatumExtentTypeInView](b3498ccf-1180-e0fd-502c-6c767f5b42cc.htm)|  Identifies whether the curve representing the datum plane is displayed according to its actual 3d extents, or else according to a view specific setting. (Inherited from [DatumPlane](3e0a6725-ee40-c4d5-839f-b7720c1fe2af.htm))  
...
![Public method](../icons/pubMethod.gif)| [GetLeader](4f5ebf97-8a85-bd5b-0edd-f2f0f6b18cb2.htm)|  Gets a copy of the leader applied to the indicated end of the datum plane. This method does not apply to Reference planes (which do not support leaders). (Inherited from [DatumPlane](3e0a6725-ee40-c4d5-839f-b7720c1fe2af.htm))  
...
![Public method](../icons/pubMethod.gif)| [GetPlaneReference](4532a1e6-9a6e-4ba3-e708-b916ec154e4b.htm)|  Returns a reference to this element as a plane.   
![Public method](../icons/pubMethod.gif)| [GetPropagationViews](ecfed956-7434-0c33-6ab0-0bc80bd2a157.htm)|  Gets a list of candidate views which are parallel to the current view and to which the extents of the datum may be propagated. (Inherited from [DatumPlane](3e0a6725-ee40-c4d5-839f-b7720c1fe2af.htm))  
...
![Public method](../icons/pubMethod.gif)| [HasBubbleInView](c216fb35-eb3b-6097-e866-989dfb1d433e.htm)|  Identifies if the DatumPlane has bubble or not. (Inherited from [DatumPlane](3e0a6725-ee40-c4d5-839f-b7720c1fe2af.htm))  
...
![Public method](../icons/pubMethod.gif)| [HideBubbleInView](1349dc55-fbac-f114-f94d-42fc5fc10b1f.htm)|  Hides the bubble in a view. This method does not apply to Reference planes. (Inherited from [DatumPlane](3e0a6725-ee40-c4d5-839f-b7720c1fe2af.htm))  
![Public method](../icons/pubMethod.gif)| [IsBubbleVisibleInView](75c39be6-5f78-9dd2-061e-13b846e739d5.htm)|  Identifies if the bubble is visible or not in a view. (Inherited from [DatumPlane](3e0a6725-ee40-c4d5-839f-b7720c1fe2af.htm))  
...
![Public method](../icons/pubMethod.gif)| [IsCurveValidInView](2fb3c757-0555-d2ba-2cd2-9399bf238735.htm)|  Checks if the curve is valid to be as the extents for the datum plane in a view. The curve must be bound and coincident with the original one of the datum plane. (Inherited from [DatumPlane](3e0a6725-ee40-c4d5-839f-b7720c1fe2af.htm))  
...
![Public method](../icons/pubMethod.gif)| [IsLeaderValid](321a1f1a-61ef-3e7a-e87a-47d4cd4fd014.htm)|  Identifies if the leader valid or not for this DatumPlane. This method does not apply to Reference planes (which do not support leaders). (Inherited from [DatumPlane](3e0a6725-ee40-c4d5-839f-b7720c1fe2af.htm))  
...
![Public method](../icons/pubMethod.gif)| [Maximize3DExtents](231447e9-0963-fe1d-8177-d8ac136f835d.htm)|  Computes the 3d extents of all model geometry and levels, and extends the 3d extents of this datum surface to include the model extents. (Inherited from [DatumPlane](3e0a6725-ee40-c4d5-839f-b7720c1fe2af.htm))  
![Public method](../icons/pubMethod.gif)| [PropagateToViews](4512810a-93c3-d127-6197-94da427d54a2.htm)| (Inherited from [DatumPlane](3e0a6725-ee40-c4d5-839f-b7720c1fe2af.htm))  
...
![Public method](../icons/pubMethod.gif)| [SetCurveInView](eaff0038-34f2-03cf-185b-2872cffb84af.htm)|  Sets the extents to match the curve. (Inherited from [DatumPlane](3e0a6725-ee40-c4d5-839f-b7720c1fe2af.htm))  
![Public method](../icons/pubMethod.gif)| [SetDatumExtentType](6509627e-dda7-4d3d-eddf-4ed462a1f68c.htm)|  Sets whether the curve representing the datum plane is displayed according to its 3d extents, or else according to a view specific setting. (Inherited from [DatumPlane](3e0a6725-ee40-c4d5-839f-b7720c1fe2af.htm))  
...
![Public method](../icons/pubMethod.gif)| [SetLeader](a771f300-9d74-3ed7-ba1b-b0961e6c36b3.htm)|  Sets the leader to the indicated end of the datum plane. This method does not apply to Reference planes (which do not support leaders). (Inherited from [DatumPlane](3e0a6725-ee40-c4d5-839f-b7720c1fe2af.htm))  
![Public method](../icons/pubMethod.gif)| [ShowBubbleInView](e8bbbf7f-38d2-d818-1738-17d844b96162.htm)|  Shows the bubble in a view. This method does not apply to Reference planes. (Inherited from [DatumPlane](3e0a6725-ee40-c4d5-839f-b7720c1fe2af.htm))  
