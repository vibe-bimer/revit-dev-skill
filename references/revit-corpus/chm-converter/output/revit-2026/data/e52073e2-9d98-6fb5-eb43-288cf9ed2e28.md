...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.htm) Autodesk.Revit.DBIndependentTag [Autodesk.Revit.DBSpanDirectionSymbol](15890f37-0c4c-2b2e-8f34-a575baee7f14.htm) [Autodesk.Revit.DB.StructureFabricReinSpanSymbol](ed051a39-7717-6be5-43a9-6f6598fd82f7.htm) [Autodesk.Revit.DB.StructurePathReinSpanSymbol](b0741415-4247-d50f-20dc-e678f40bd65e.htm) [Autodesk.Revit.DB.StructureRebarSystemSpanSymbol](f749c169-ea93-fb71-eb1e-c6febb10e54d.htm)
...
![Public property](../icons/pubProperty.gif)| [HasLeader](ce3fe3a9-4048-3b29-4dcb-57ca86de4267.htm)|  Identifies if a tag has at least one visible leader, or if all leaders are hidden.   
...
![Public property](../icons/pubProperty.gif)| [IsMaterialTag](7670e365-227c-bc9d-a4b0-c77f793034e2.htm)|  Identifies if it is a material tag or not.   
...
![Public property](../icons/pubProperty.gif)| [IsMulticategoryTag](91f6e4f0-6a6b-efa6-5730-ea32a5cb203c.htm)|  Identifies if it is a multi-category tag or not.   
![Public property](../icons/pubProperty.gif)| [IsOrphaned](4906fa9c-e424-92e7-0b7e-15389726ca78.htm)|  Identifies if the tag is orphaned or not.   
...
![Public property](../icons/pubProperty.gif)| [LeaderEndCondition](0b0575d6-446d-d3e8-3ef7-12faed553b20.htm)|  The leader end condition of the tag, such as if the end of the leader is attached to the host or free floating.   
![Public property](../icons/pubProperty.gif)| [LeadersPresentationMode](f0d5e29e-0407-cdc0-cdf7-69ea516bd632.htm)|  Identifies the Presentation Mode that is applied to tag leaders.   
...
![Public property](../icons/pubProperty.gif)| [MergeElbows](5c5ad800-7512-be12-dc1a-ebcda5513622.htm)|  Identifies if the leaders' elbows are merged or not. If they are are merged, all elbows are in the same point and they move together.   
![Public property](../icons/pubProperty.gif)| [MultiLeader](5501affb-b03f-8bca-de56-c12a42915bc6.htm)|  Returns if the tag if referencing multiple elements and/or sub-elements.   
![Public property](../icons/pubProperty.gif)| [MultiReferenceAnnotationId](30363f1b-0fd1-fa0e-5617-be77d683662e.htm)|  The multi-reference annotation which owns this tag.   
...
![Public property](../icons/pubProperty.gif)| [RotationAngle](3b257113-5220-c9df-dd3c-50e1e28b847b.htm)|  The rotation angle of the tag relative to its view   
![Public property](../icons/pubProperty.gif)| [TagHeadPosition](4f49d3f3-e5c5-108a-49dd-2a36697bd08e.htm)|  The position of the head of tag in model coordinates.   
![Public property](../icons/pubProperty.gif)| [TagOrientation](d9d43a13-a972-3b69-2484-b6e336e9a0c5.htm)|  The tag orientation of the tag's head, such as horizontal or vertical.   
![Public property](../icons/pubProperty.gif)| [TagText](8e297dee-920d-f620-6198-0bed494e3f04.htm)|  The text associated with the tag. If there are several strings assiciated with the tag, the strings will be returned concatenated.   
...
| Name| Description  
---|---|---  
![Public method](../icons/pubMethod.gif)| [AddReferences](333fc505-2f6b-e754-6841-fb7f7639284e.htm)|   
...
![Public method](../icons/pubMethod.gif)| [CanLeaderEndConditionBeAssigned](83343fd7-5244-12ae-faa0-3fcf082d483e.htm)|  Checks whether the LeaderEndCondition can be changed.   
...
![Public method](../icons/pubMethod.gif)| [GetLeaderElbow](cb3f9617-d5a4-7c45-1686-d7c2f60effad.htm)|  Returns the position of the elbow of the tag's leader that points to specified reference. Position of leader's elbow.   
![Public method](../icons/pubMethod.gif)| [GetLeaderEnd](d6f69738-aa40-d45c-5ab5-ba02d55d0837.htm)|  Returns the end position of the tag's leader that points to specified reference.   
...
![Public method](../icons/pubMethod.gif)| [GetTaggedElementIds](43260944-f46c-d5df-c9ea-f3a44e24d1a2.htm)|  Returns a set of LinkElementId for all tagged elements, if any. A LinkElementId will be provided for each subelement that is being referenced by the tag.   
...
![Public method](../icons/pubMethod.gif)| [GetTaggedLocalElements](f238e2c7-e184-172c-546a-7dd694857e56.htm)|  Get the tagged local elements, if any. An Element will be provided for each subelement that is being referenced by the tag.   
![Public method](../icons/pubMethod.gif)| [GetTaggedReferences](63a90870-6b37-57b2-26fe-6fa1e605a9da.htm)|  Get the host references of the tag. An array of all the tagged references.   
...
![Public method](../icons/pubMethod.gif)| [HasLeaderElbow](f4febfed-3134-a5c0-0f8e-d4e6c5b4b675.htm)|  Whether the tag's leader that points to the reference has an elbow point or not.   
...
![Public method](../icons/pubMethod.gif)| [HasTagBehavior](fadc39b4-eb80-2e00-f9af-e5752a0bb498.htm)|  Checks if the IndependentTag has a tag behavior.   
![Public method](../icons/pubMethod.gif)| [HasTagText](e32f82d2-9aaa-5845-397f-6ff9264ad31b.htm)|  Checks if the IndependentTag has a valid tag text.   
...
![Public method](../icons/pubMethod.gif)| [IsLeaderVisible](8ad822df-1fb8-938f-66d4-60ade8983c40.htm)|  Returns if leader that points to specified reference is visible or not.   
...
![Public method](../icons/pubMethod.gif)| [IsTaggedOnSubelement](8f6f8b8c-1b1b-1141-e165-1eecd4b765a1.htm)|  Returns true if the any of the tagged references is a subelement.   
...
![Public method](../icons/pubMethod.gif)| [RemoveReferences](902f7f27-964e-d7cd-e582-07f45750d768.htm)|   
...
![Public method](../icons/pubMethod.gif)| [SetIsLeaderVisible](b0b7f9bc-163b-01a6-9a8c-fa7cfc6c61a0.htm)|  Set tag's leader that points to specified reference to be visible or not. This option can be set only if the LeadersPresentationMode is ShowSpecificLeaders.   
![Public method](../icons/pubMethod.gif)| [SetLeaderElbow](dd5a7d21-cb13-d3d7-6dd6-8e8e427e4873.htm)|  Set the position of the elbow of the tag's leader that points to specified reference. If this tag is a multileader tag and the elbows are merged, the input position will be set to all leaders.   
![Public method](../icons/pubMethod.gif)| [SetLeaderEnd](fb54c007-6873-68f4-4772-e777609a441b.htm)|  Set the end position of the tag's leader that points to specified reference.   
