...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.htm) Autodesk.Revit.DB.ElectricalConduitSizeSettings
...
| Name| Description  
---|---|---  
![Public method](../icons/pubMethod.gif)| [AddSize](dcb1141a-656d-31fd-7e04-e2ffe12da313.htm)|  Inserts a new ConduitSize in to the conduit size settings. The conduit standard name determines the location of the new size in the size table.   
...
![Public method](../icons/pubMethod.gif)| [CreateConduitStandardTypeFromExisingStandardType](140bee14-3c01-d17a-5017-2f4301524c04.htm)|  Creates one conduit standard type with the new name and assign the conduit sizes to it from the existing standard type.   
...
![Public method](../icons/pubMethod.gif)| [DoesConduitStandardTypeExist](3ef858e5-0984-0d1d-c063-2ff07feed167.htm)|  Checks if the specified conduit standard exist.   
...
![Protected method](../icons/protMethod.gif)| [GetBasicIEnumerator](52ead6fa-0234-1689-518f-82ab16fe4a18.htm)| Returns an enumerator that iterates through a collection.  
![Public method](../icons/pubMethod.gif)![Static member](../icons/Static.gif)| [GetConduitSizeSettings](f46950b6-1f00-7137-663f-cf1fb8b5e99a.htm)|  Gets the conduit size settings of the project.   
![Public method](../icons/pubMethod.gif)| [GetConduitSizeSettingsIterator](8d9283aa-e31a-b7bc-66e3-08b9ed143d54.htm)|  Returns a ConduitSizeSettingIterator to the conduit size settings.   
...
![Public method](../icons/pubMethod.gif)| [GetEnumerator](85207543-4387-b1e5-0db7-0106f0344785.htm)| Returns an enumerator that iterates through a collection.  
...
![Public method](../icons/pubMethod.gif)| [GetSizeCount](cc196c19-2cb5-9120-879d-12053637af11.htm)|  Gets the size count of the conduit size table. The conduit standard name the location of the size in the size table.   
...
![Public method](../icons/pubMethod.gif)| [RemoveConduitStandardType](608651d0-d4f2-d85a-5230-672dd360d4e2.htm)|  Erases the existing ConduitSizes with this conduit standard name; the consuit standard type can not be removed if it is in use.   
![Public method](../icons/pubMethod.gif)| [RemoveSize](e16228d0-e1a4-d583-aa5f-4338390688d3.htm)|  Erase the existing ConduitSize with this nominal diameter. The conduit standard name determines the location of the size in the size table.   
