...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.htm) Autodesk.Revit.DBMultiReferenceAnnotation
...
![Public property](../icons/pubProperty.gif)| [DimensionId](99cb3709-901d-d73d-4e0d-4c75d3e0237e.htm)|  The child dimension owned by this multi-reference annotation.   
...
![Public property](../icons/pubProperty.gif)| [TagId](33f7bb8b-f277-0eee-e7ec-69c53e2d21e1.htm)|  The child IndependentTag owned by this multi-reference annotation.   
...
| Name| Description  
---|---|---  
![Public method](../icons/pubMethod.gif)![Static member](../icons/Static.gif)| [AreElementsValidForMultiReferenceAnnotation](b49935de-bcad-70d0-cc8d-e53e4cb34031.htm)|  The method validates if the input elements match the element category id for the MultiReferenceAnnotationType.   
...
![Public method](../icons/pubMethod.gif)![Static member](../icons/Static.gif)| [AreReferencesValidForLinearDimension](3e6aaebc-28a1-da82-8022-ec76d26122c6.htm)|  If the DimensionStyleType is Linear, validates that the references are valid for an aligned multi-reference annotation.   
![Public method](../icons/pubMethod.gif)![Static member](../icons/Static.gif)| [AreReferencesValidForLinearFixedDimension](75111b29-eff1-c970-7f70-ba3cbcf7766e.htm)|  If the DimensionStyleType is LinearFixed, validates that the references are valid for an aligned multi-reference annotation.   
...
![Public method](../icons/pubMethod.gif)![Static member](../icons/Static.gif)| [Create](b3646880-ef76-d0d4-68d9-2c976163c340.htm)|  Creates a new MultiReferenceAnnotation.   
...
![Public method](../icons/pubMethod.gif)![Static member](../icons/Static.gif)| [IsLinearFixedDimensionDirectionValid](15ea4e06-bb36-6328-e456-6c4528766a23.htm)|  If the DimensionStyleType is LinearFixed, this function verifies that the dimension line direction matches either the view's vertical or horizontal direction.   
