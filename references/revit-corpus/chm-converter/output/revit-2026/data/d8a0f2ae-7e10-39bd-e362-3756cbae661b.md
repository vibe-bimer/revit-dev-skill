...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.htm) [Autodesk.Revit.DBParameterElement](2ad60b36-07d6-6aed-62c7-89f388f05ffb.htm) Autodesk.Revit.DBSharedParameterElement
...
![Public property](../icons/pubProperty.gif)| [GuidValue](5f6a55c4-a80f-225a-c26b-45e89e91c74c.htm)|  The Guid that identifies this shared parameter.   
...
![Public method](../icons/pubMethod.gif)![Static member](../icons/Static.gif)| [Create](c6430d77-b3e5-2a67-02b2-4896f83ba932.htm)|  Creates a new shared parameter element in the document representing the parameter stored in the input ExternalDefinition.   
...
![Public method](../icons/pubMethod.gif)![Static member](../icons/Static.gif)| [Lookup](4dce82de-7495-523a-c8d4-4b3fc709e85e.htm)|  Finds the shared parameter element that corresponds to the given Guid.   
...
![Public method](../icons/pubMethod.gif)| [ShouldHideWhenNoValue](c9cfaeab-a393-e255-fa8e-418afdc6f6c5.htm)|  Indicates whether the parameter should be hidden from the properties palette if it has no value.   
