...
| Name| Description  
---|---|---  
![Public property](../icons/pubProperty.gif)| [AirDensity](fffd52f7-044c-1a46-6943-ff877dec3279.htm)|  The air density in kg/ft^3.   
![Public property](../icons/pubProperty.gif)| [AirDynamicViscosity](d06453cd-944c-38bf-9c81-1ee23481353a.htm)|  The dynamic viscosity of air in kg/(ft*s).   
...
![Public property](../icons/pubProperty.gif)| [Centerline](9a7b2e55-5810-62ea-76a4-5db9b5f2e5ab.htm)|  The abbreviation of the Centerline (=) string.   
![Public property](../icons/pubProperty.gif)| [ConnectorSeparator](ca95fd1d-8c62-437a-f0be-feefe37ec20f.htm)|  The duct connector separator string.   
...
![Public property](../icons/pubProperty.gif)| [FittingAngleUsage](8112e243-c20e-35e6-02aa-f0e061538cd0.htm)|  Determine how to use fitting angle during duct layout or modifying layout.   
![Public property](../icons/pubProperty.gif)| [FittingAnnotationSize](ad1cbd39-b54e-6532-3db4-4621d0158663.htm)|  The value of fitting annotation size.   
![Public property](../icons/pubProperty.gif)| [FlatOnBottom](6d4acd42-372e-9ed4-bad2-dc019b99239f.htm)|  The abbreviation of the Flat On Bottom (FOB) string.   
![Public property](../icons/pubProperty.gif)| [FlatOnTop](717ef71c-64bf-953a-adad-213004aaf6ca.htm)|  The abbreviation of the Flat On Top (FOT) string.   
...
![Public property](../icons/pubProperty.gif)| [NetworkBasedCalculations](b888c721-828c-a71e-32bb-5545f8e07103.htm)|  Indicates whether to enable network based calculations for duct networks.   
![Public property](../icons/pubProperty.gif)| [OvalDuctSizeSeparator](fcde64b8-e345-25cd-29ad-0164438b16ef.htm)|  The oval duct size separator string.   
![Public property](../icons/pubProperty.gif)| [OvalDuctSizeSuffix](01a4fd90-4660-a555-b3d4-4388b3e9b4c3.htm)|  The oval duct size suffix string.   
...
![Public property](../icons/pubProperty.gif)| [RectangularDuctSizeSeparator](5bbed76e-f811-b98b-288a-6f74aa2b0f2c.htm)|  The rectangular duct size separator string.   
![Public property](../icons/pubProperty.gif)| [RectangularDuctSizeSuffix](6f59f18c-7a72-2819-3670-19f80aede525.htm)|  The rectangular duct size suffix string.   
![Public property](../icons/pubProperty.gif)| [RiseDropAnnotationSize](37074af6-8bb9-b562-2521-a0370382eed8.htm)|  The rise drop annotation size.   
![Public property](../icons/pubProperty.gif)| [RoundDuctSizePrefix](d1f1f1df-ff92-8640-4aa1-72dd2ef1114c.htm)|  The round duct size prefix string.   
![Public property](../icons/pubProperty.gif)| [RoundDuctSizeSuffix](abf0c448-17e8-dd63-bc37-8e695d268b75.htm)|  The round duct size suffix string.   
![Public property](../icons/pubProperty.gif)| [SetDown](a6b3a1bd-acd6-6ed0-ff42-00cf4ef48d18.htm)|  The abbreviation of the Set Down from top (TD) of fitting string.   
![Public property](../icons/pubProperty.gif)| [SetDownFromBottom](a58f3175-0d33-e7ae-fe40-e332b19ea490.htm)|  The abbreviation of the Set Down from bottom (BD) of fitting string.   
![Public property](../icons/pubProperty.gif)| [SetUp](158723ab-631f-05b6-48d2-75cd9aa0edf0.htm)|  The abbreviation of the Set Up from top (TU) of fitting string.   
![Public property](../icons/pubProperty.gif)| [SetUpFromBottom](45e7e748-e45b-1d98-04db-ea9a48314163.htm)|  The abbreviation of the Set Up from bottom (BU) of fitting string.   
...
![Public property](../icons/pubProperty.gif)| [UseAnnotationScaleForSingleLineFittings](ca019bfb-0ff9-8e14-9848-797bd3fcdd9a.htm)|  Indicates whether use annotation scale for single line fittings or not.   
