...
#### Return Value
[RebarConstraint](748823c8-f059-68c1-d7b5-7cfaba93a445.htm) Returns the current constraint for the end handle of the Rebar. Return value is null is no constraint is present. 
#### Reference
