...
externalDefinition [ExternalDefinition](a3e84415-b88e-a8e0-4e11-64795d92da0e.htm)
    A shared parameter.
#### Return Value
[ElementId](44f3f7b1-3229-3404-93c9-dc5e70337dd6.htm) An ElementId representing the shared parameter stored in the document, or InvalidElementId if the parameter is not stored in the document. 
Exception| Condition  
---|---  
