...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.htm) Autodesk.Revit.DB.StructureStructuralSettings
...
![Public property](../icons/pubProperty.gif)| [BoundaryConditionAreaAndLineSymbolSpacing](41fe8298-38d8-759d-56ea-6f0fcf364170.htm)|  Symbol spacing for boundary conditions.   
![Public property](../icons/pubProperty.gif)| [BoundaryConditionFamilySymbolFixed](64993be8-d46b-527f-67c5-5f9d63240b3c.htm)|  The id of the FamilySymbol to represent a fixed boundary condition.   
![Public property](../icons/pubProperty.gif)| [BoundaryConditionFamilySymbolPinned](d8839f2b-4024-baf7-bf62-6a792f633097.htm)|  The id of the FamilySymbol to represent a pinned boundary condition.   
![Public property](../icons/pubProperty.gif)| [BoundaryConditionFamilySymbolRoller](75e1056d-07de-cfe4-6bb3-5a549bcbbe69.htm)|  The id of the FamilySymbol to represent a roller boundary condition.   
![Public property](../icons/pubProperty.gif)| [BoundaryConditionFamilySymbolUserDefined](fe698c55-f209-acd4-afd1-14223f7be0f4.htm)|  The id of the FamilySymbol to represent a user-defined boundary condition.   
![Public property](../icons/pubProperty.gif)| [BoundarySetbackDisabledForSteelElements](e975b36b-0c0e-3925-6804-b72834a9ca3f.htm)|  Disallow shortening (setbacks) to joined element boundaries for beams and braces. If enabled, then beams and braces will have the setbacks set to 0 by default. Explicit setbacks to references will still be allowed.   
...
![Public property](../icons/pubProperty.gif)| [BraceAboveSymbol](c62a04e2-84cd-1458-3ad8-0fe9410d5778.htm)|  The id of the ElementType to represent a brace above a beam in plan view.   
![Public property](../icons/pubProperty.gif)| [BraceBelowSymbol](825c1d61-be16-df37-2f08-06e6651e8203.htm)|  The id of the ElementType to represent a brace below a beam in plan view.   
![Public property](../icons/pubProperty.gif)| [BraceParallelLineOffset](66fb3510-3fc7-d80b-9515-3593e1459e81.htm)|  The distance by which brace symbols in plan views will be offset.   
...
![Public property](../icons/pubProperty.gif)| [KickerBraceSymbol](ed543557-7917-0666-a9ae-3beb9f33fb6a.htm)|  The id of the ElementType to represent a kicker brace.   
...
![Public property](../icons/pubProperty.gif)| [ShowBraceAbove](31199607-7a4e-3c68-a488-cc08fe99ae0b.htm)|  Whether to show brace symbols above beams in plan views.   
![Public property](../icons/pubProperty.gif)| [ShowBraceBelow](6ff59723-eb73-92c5-be2a-26f9cc153869.htm)|  Whether to show brace symbols below beams in plan views.   
![Public property](../icons/pubProperty.gif)| [SymbolicCutbackForBeamAndTruss](2a88cde1-523e-0f96-4777-801aa82bf488.htm)|  Symbolic cutback distance to be applied to all beams and trusses.   
![Public property](../icons/pubProperty.gif)| [SymbolicCutbackForBrace](29b92b97-347d-39ff-17aa-a82159f80d8f.htm)|  Symbolic cutback distance to be applied to all braces.   
![Public property](../icons/pubProperty.gif)| [SymbolicCutbackForColumn](99683223-da0b-4a67-149f-cb4a1e9ef184.htm)|  Symbolic cutback distance to be applied to all columns.   
...
![Public property](../icons/pubProperty.gif)| [UseLoadsDisplayScaling](77cc2234-172a-e52c-9c98-067f81843a57.htm)|  Whether to use loads display scaling. If disabled then loads are displayed according to force scale type parameters.   
...
![Public method](../icons/pubMethod.gif)| [GetLoadForceVectorReprLine](1d9e4033-43bb-2d98-fdf5-f18bf24c8329.htm)|  Returns the representative line of the load force vector according to loads display scaling.   
...
![Public method](../icons/pubMethod.gif)![Static member](../icons/Static.gif)| [GetStructuralSettings](a1ca56a0-3d21-3824-aa38-d34174ffd727.htm)|  Obtains the StructuralSettings object for the specified project document.   
...
![Public method](../icons/pubMethod.gif)| [SetValuesForLoadsDisplayScaling](e3a18f6d-3d95-b910-c33d-b678c6c57df5.htm)|  Sets values for loads display scaling by providing two load forces and their corresponding length of the representative lines in internal units.   
