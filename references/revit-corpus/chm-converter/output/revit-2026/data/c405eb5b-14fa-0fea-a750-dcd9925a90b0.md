...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.htm) Autodesk.Revit.DBColorFillScheme
...
| Name| Description  
---|---|---  
![Public property](../icons/pubProperty.gif)| [AreaSchemeId](e24d76dd-38fb-c951-7ae4-d10101b4981b.htm)|  Represents the id of AreaScheme of area plan views that this scheme could be applied to.   
...
![Public property](../icons/pubProperty.gif)| [CategoryId](7f1d0a3c-4194-f165-0203-5aba9431a1b8.htm)|  Represents the element category that can be colored by this scheme.   
...
![Public property](../icons/pubProperty.gif)| [IsByRange](2e6a3c32-a3f8-a6dd-6552-7ba7a901d9fb.htm)|  Represents if the parameter values in entries are treated as value range or not.   
![Public property](../icons/pubProperty.gif)| [IsLinkedFilesIncluded](128e90fd-f78f-42c5-e1a8-aa7a34363634.htm)|  Represent if the scheme includes entries whose parameter values are based on elements from linked files.   
...
![Public property](../icons/pubProperty.gif)| [ParameterDefinition](554f7720-d040-ebcf-5986-9910b8038b87.htm)|  Represents the parameter of the elements that this scheme could be used to color.   
...
![Public property](../icons/pubProperty.gif)| [StorageType](41c8e61c-fa40-0d69-9c5c-d955baaddbf5.htm)|  Represents the type of parameter values stored in entries.   
![Public property](../icons/pubProperty.gif)| [Title](4a9768ad-6b47-5ac4-b4c3-b67717268fee.htm)|  Represents the title displayed in [ColorFillLegend](81cbdc7c-9f7f-b454-5669-77ca0514eda7.htm).   
...
| Name| Description  
---|---|---  
![Public method](../icons/pubMethod.gif)| [AddEntry](8c7f6d04-66ab-19ef-d00c-445aa4570f82.htm)|  Adds new entry to the scheme.   
![Public method](../icons/pubMethod.gif)| [AreEntriesConsistentWithScheme](a368c926-4d60-0fde-4e21-0a7c815db691.htm)|   
...
![Public method](../icons/pubMethod.gif)| [CanDefineByRange](f4592c9f-40f1-703c-21e7-17bb7c2f3747.htm)|  Checks whether the scheme entries can be explained by range.   
...
![Public method](../icons/pubMethod.gif)| [CanRemoveEntry](d19264f1-e9f1-462f-f2c3-7f4ae9f2c9d0.htm)|  Checks whether entry can be removed from the scheme.   
![Public method](../icons/pubMethod.gif)| [CanUpdateEntry](f7f0bdd9-8076-69f1-bf81-776c40f42a22.htm)|  Checks whether entry exists in the scheme and not the same as input one.   
...
![Public method](../icons/pubMethod.gif)| [Duplicate](095596ae-d215-bf22-ccfa-fae85109d1a0.htm)|  Generates a copy of current scheme.   
...
![Public method](../icons/pubMethod.gif)| [GetEntries](bb3b650c-2718-28b7-c4bb-be3f80fb3e32.htm)|  Retrieves copies of all entries.   
...
![Public method](../icons/pubMethod.gif)| [GetFormatOptions](74e725cd-a74e-5ac6-d01e-0d1022208eb1.htm)|  Returns the FormatOptions of the scheme.   
...
![Public method](../icons/pubMethod.gif)| [GetSupportedParameterIds](d19ac539-c56d-1c3c-1b7b-8801e9713c06.htm)|  Retrieves collection of all parameters supported by the scheme.   
...
![Public method](../icons/pubMethod.gif)| [IsEntryConsistentWithScheme](887cb0a0-2ad3-9a2c-8f46-c86e404539f8.htm)|  Checks whether an entry can be added to the scheme or not.   
...
![Public method](../icons/pubMethod.gif)| [IsValidParameterDefinitionId](df43fe3e-0b93-ef67-c877-eedbaf6a7f49.htm)|  Checks whether the input parameter id can be applied to the scheme.   
![Public method](../icons/pubMethod.gif)| [IsValidSchemeName](ecae1c30-8417-dae7-8364-30f75145bb06.htm)|  Checks whether the name is valid for new generated scheme.   
...
![Public method](../icons/pubMethod.gif)| [RemoveEntry](e7441d50-0e17-21be-8ff6-aadadacad417.htm)|  Removes an entry whose parameter value is the same as the input from the scheme   
...
![Public method](../icons/pubMethod.gif)| [SetEntries](a2099010-ccb3-5ad1-5e80-5209422add42.htm)|   
![Public method](../icons/pubMethod.gif)| [SetFormatOptions](6558114a-4587-ff68-17a9-e58f0dfea0bb.htm)|  Sets the FormatOptions of the scheme.   
![Public method](../icons/pubMethod.gif)| [SortEntries](b1cec6a3-6b60-b47f-2ea6-a6d7df9555c0.htm)|  Sorts the scheme entries ascending.   
![Public method](../icons/pubMethod.gif)| ToString| Returns a string that represents the current object.(Inherited from Object)  
![Public method](../icons/pubMethod.gif)| [UpdateEntry](47fece43-de9a-e343-62be-e6907c584933.htm)|  Updates the scheme entry with the same parameter value as the input entry.   
Top
...
Notes:
  * To apply a color scheme whose [CategoryId](7f1d0a3c-4194-f165-0203-5aba9431a1b8.htm) property is OST_Areas to an area plan view, the [AreaSchemeId](e24d76dd-38fb-c951-7ae4-d10101b4981b.htm) property must be the same as the view if it is not used as a template. 
