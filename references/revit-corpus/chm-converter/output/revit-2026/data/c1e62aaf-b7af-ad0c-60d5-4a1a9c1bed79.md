...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.htm) Autodesk.Revit.DB.AnalysisMassLevelData
...
![Public method](../icons/pubMethod.gif)| [IsEmpty](c9e0abfe-b8fa-e48b-edab-b83185b158fb.htm)|  Indicates if the MassLevelData (Mass Floor) has a geometrical representation. May not if the level does not intersect the mass geometry.   
...
![Public method](../icons/pubMethod.gif)![Static member](../icons/Static.gif)| [IsMassFamilyInstance](a2bc9949-9c4f-afc4-6c79-38050507e784.htm)|  Checks if the ElementId is a mass family instance.   
...
![Public method](../icons/pubMethod.gif)| [IsValidConceptualConstructionTypeElement](453bc7cc-a667-fdb6-72d9-efb2db40badd.htm)|  Checks if the ElementId is an acceptable conceptual construction type ElementId for the MassLevelData (Mass Floor).   
