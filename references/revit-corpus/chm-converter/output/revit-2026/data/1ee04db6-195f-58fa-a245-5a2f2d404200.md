...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.htm) Autodesk.Revit.DBPart
...
![Public property](../icons/pubProperty.gif)| [Excluded](0eb9588f-17af-18d7-f9ed-cc831b0585db.htm)|  True if the part is excluded, false otherwise   
...
![Public property](../icons/pubProperty.gif)| [OriginalCategoryId](a06ea771-6aea-6a39-9036-4d3f1389b7ed.htm)|  The category Id of the original element corresponding to this Part.   
...
![Public property](../icons/pubProperty.gif)| [PartMaker](67743418-5f84-a6b6-cfcf-14d8072391b1.htm)|  The PartMaker that created this Part.   
...
![Public method](../icons/pubMethod.gif)| [CanOffsetFace](ca466002-8d4e-bd3c-e591-5ca37c983bb1.htm)|  Checks if it is possible to offset the given face.   
...
![Public method](../icons/pubMethod.gif)| [GetFaceOffset](a4bb499a-8705-5138-0e15-74fb5bc4508b.htm)|  Get face offset of the given part face.   
...
![Public method](../icons/pubMethod.gif)| [GetSourceElementIds](35943e3b-b8d2-2bd6-6258-27599d012ee8.htm)|  Gets a collection of elements from which this Part is created by the PartMaker. May return more than one source only if there is merge involved somewhere in the history of this Part.   
![Public method](../icons/pubMethod.gif)| [GetSourceElementOriginalCategoryIds](47f225e0-6be6-22fc-8005-4f0e68d95674.htm)|  Gets the category ids of the source elements which were used to form this part.   
...
![Public method](../icons/pubMethod.gif)| [ResetFaceOffset](6e715369-6f25-adec-e331-25f43d9a75fd.htm)|  Resets the offset applied to the given part face.   
![Public method](../icons/pubMethod.gif)| [ResetPartShape](9cedb531-7e03-ae4d-53d8-4561dbbb7f23.htm)|  Resets all face offsets applied to part faces.   
...
![Public method](../icons/pubMethod.gif)| [SetFaceOffset](6d2cb1e0-1754-8f71-f02f-70c153fe6bde.htm)|  Offsets the given part face in the direction that points out of the solid shape with the specified amount. Negative value will offset the face into the solid shape.   
