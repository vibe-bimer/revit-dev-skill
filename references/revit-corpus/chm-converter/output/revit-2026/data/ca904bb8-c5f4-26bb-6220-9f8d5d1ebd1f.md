...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.htm) Autodesk.Revit.DB.StructureReinforcementSettings
...
![Public property](../icons/pubProperty.gif)| [HostStructuralRebar](e778d21b-369f-ffc2-ab0f-9191fec3cd8f.htm)|  Host Structural Rebar within Area and Path Reinforcement with touching AtomHostStructuralRebar.   
...
![Public property](../icons/pubProperty.gif)| [NumberingMethod](41b7c755-b580-71a4-fa3c-76ed4f4a326a.htm)|  Identifies the type of the numbering method.   
![Public property](../icons/pubProperty.gif)| [NumberVaryingLengthRebarsIndividually](7b74062d-8c65-4145-1d8c-23302ebc5b61.htm)| **Obsolete.** Use this option to modify the way varying length bars are numbered (individually or as a whole).   
...
![Public property](../icons/pubProperty.gif)| [RebarPresentationInSection](511b0bb9-155f-3397-9a13-d41100fc8d72.htm)|  The default presentation mode for rebar sets, when: 
...
![Public property](../icons/pubProperty.gif)| [RebarPresentationInView](8a1b166e-3bea-5862-3fa4-996419581c5a.htm)|  The default presentation mode for rebar sets, when the view direction is perpendicular to the rebar normal and the rebar set is not cut.   
![Public property](../icons/pubProperty.gif)| [RebarShapeDefinesEndTreatments](1961031f-e056-da42-215f-bf7d3ddcd530.htm)|  End Treatments are defined by Rebar Shape of Rebar element. Can be changed if document contains no rebars, area reinforcements and path reinforcements.   
![Public property](../icons/pubProperty.gif)| [RebarShapeDefinesHooks](dac8f11f-7001-41a2-5b51-5d619a4e2231.htm)|  Hooks are defined by Rebar Shape of Rebar element. Can be changed if document contains no rebars, area reinforcements and path reinforcements.   
![Public property](../icons/pubProperty.gif)| [RebarVaryingLengthNumberSuffix](4fbbb672-5f0c-fc86-3fce-2b1a16127fff.htm)|  A unique identifier used for a bar within a variable length rebar set.   
...
![Public method](../icons/pubMethod.gif)| [GetFabricRoundingManager](e8fd5c2d-5fa1-1b02-4e4e-4057680a756e.htm)|  Returns an object for managing reinforcement rounding override settings used by FabricSheetType and FabricSheet elements.   
...
![Public method](../icons/pubMethod.gif)| [GetRebarRoundingManager](0471fc13-76ea-a071-b6b6-f26586ba7dd6.htm)|  Returns an object for managing reinforcement rounding override settings used by RebarBarTypes, Rebar and RebarInSystem elements.   
![Public method](../icons/pubMethod.gif)| [GetReinforcementAbbreviationTag](aa2e274b-4a04-2382-958e-ae8c5da76d34.htm)|  Gets one abbreviation tag for desired ReinforcementAbbreviationTagType.   
![Public method](../icons/pubMethod.gif)| [GetReinforcementAbbreviationTags](c99a81c9-19ec-3983-beb7-e6080a5f6431.htm)|  Gets a list of abbreviation tags for desired reinforcement object type.   
![Public method](../icons/pubMethod.gif)![Static member](../icons/Static.gif)| [GetReinforcementSettings](870cbfee-b1d4-0dd8-3e14-4802f3eafd25.htm)|  Obtains the ReinforcementSettings object for the specified project document.   
...
![Public method](../icons/pubMethod.gif)| [IsEqual](f6924dbf-c3de-6b0a-ba9f-166a9c8a8819.htm)|  Checks if Reinforcement Settings is equal to other   
...
![Public method](../icons/pubMethod.gif)| [SetReinforcementAbbreviationTag](9907ed20-d7dd-f387-01e8-76f66f1c76f2.htm)|  Sets one abbreviation tag for desired ReinforcementAbbreviationTagType.   
