...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.htm) [Autodesk.Revit.DBElementType](ffb18296-0448-559c-580c-7857cbcdc094.htm) Autodesk.Revit.DBRevitLinkType
...
![Public property](../icons/pubProperty.gif)| [AttachmentType](456da4bd-16ef-a039-9934-2644f84fdb3b.htm)|  The attachment/overlay status of this link.   
...
![Public property](../icons/pubProperty.gif)| [IsNestedLink](cae32f75-fc08-8625-650a-dc6427d3b985.htm)|  Indicates whether this link is a nested or top-level link.   
...
![Public property](../icons/pubProperty.gif)| [LocallyUnloaded](ae370efc-5079-dbd8-5fb5-713086aae86e.htm)|  Checks whether a Revit link in a local model is unloaded only for the current user.   
...
![Public property](../icons/pubProperty.gif)| [PathType](c0517436-dea9-9728-1876-de384b2fbc96.htm)|  The type of path the link uses.   
...
![Public method](../icons/pubMethod.gif)| [GetChildIds](8336bb72-f686-c742-dbbe-b6245e6b33b4.htm)|  Gets the ids of the immediate children of this link.   
![Public method](../icons/pubMethod.gif)| [GetConversionData](9809ada4-fced-197c-7e4c-f339e75a2b80.htm)|  Returns the optional data that is necessary to generate the Revit file for this link.   
...
![Public method](../icons/pubMethod.gif)| [GetLinkedFileStatus](796710c2-4c58-af44-affa-eab4f985b5f3.htm)|  Returns the LinkedFileStatus of this link.   
...
![Public method](../icons/pubMethod.gif)| [GetParentId](937f7497-a73c-f97c-dc49-1da47d098200.htm)|  Gets the id of this link's immediate parent.   
![Public method](../icons/pubMethod.gif)| [GetPhaseMap](4d322c11-c2b3-a096-4f10-3b23c9112308.htm)|  Returns a mapping between phases in the host document and phases in the linked document.   
...
![Public method](../icons/pubMethod.gif)| [GetRootId](f50ff34a-11db-04ae-8085-636be561031d.htm)|  Gets the id of the top-level link which this link is linked into.   
...
![Public method](../icons/pubMethod.gif)| [HasSaveablePositions](2759f2e4-241d-f39d-c450-2b5674af5b24.htm)|  Determines whether the link has changes to shared positioning that could be saved.   
...
![Public method](../icons/pubMethod.gif)| [IsFromLocalPath](ff52a707-e3cc-4b90-d15b-d9db4f52766a.htm)|  Checks whether the Revit link uses a local path, such as a hard drive.   
![Public method](../icons/pubMethod.gif)| [IsFromRevitServer](514f1781-700e-558c-70c9-c9328139da6c.htm)|  Checks whether the Revit link is located on Revit Server.   
...
![Public method](../icons/pubMethod.gif)![Static member](../icons/Static.gif)| [IsLoaded](a59a0c41-0fe3-9ecf-e448-82414966b745.htm)|  Checks whether the link with this id is loaded.   
...
![Public method](../icons/pubMethod.gif)| [IsNotLoadedIntoMultipleOpenDocuments](7e675de0-ce86-ef2e-fdef-f5e12558684d.htm)|  Checks whether the link is loaded into more than one open document in this session of Revit. If the link is loaded into multiple open documents, reload will be disabled.   
...
![Public method](../icons/pubMethod.gif)| [Load](f46b3b6c-1a9e-a2ab-19d7-367918b3e9f0.htm)|  Loads or reloads the Revit link from its currently-stored location. If the link is an external resource, Revit will contact the IExternalResourceServer to get the latest version of the link.   
![Public method](../icons/pubMethod.gif)| [LoadFrom(ExternalResourceReference, WorksetConfiguration)](f76e2dd3-7448-3aac-baf7-303851f50873.htm)|  Loads or reloads the Revit link. The link will be loaded from the location given in the input ExternalResourceReference.   
![Public method](../icons/pubMethod.gif)| [LoadFrom(ModelPath, WorksetConfiguration)](bdb3a91e-9a0a-e68d-51da-c460535f5fd2.htm)|  Loads or reloads the Revit link from disk or cloud. The link will be loaded from the input path.   
...
![Public method](../icons/pubMethod.gif)| [Reload](86830eb9-5ddb-c342-fddd-6963e5c03564.htm)|  Loads or reloads the Revit link from its currently-stored location. If the link is an external resource, Revit will contact the IExternalResourceServer to get the latest version of the link.   
![Public method](../icons/pubMethod.gif)| [RevertLocalUnloadStatus](4768dc29-83be-99f9-169c-a723202a1b8d.htm)|  Restores the workshared load status of a link that has been unloaded only for the current user, in a local copy of a workshared model.   
![Public method](../icons/pubMethod.gif)| [SavePositions](2bfb9cc1-5a29-a195-0892-92bef673ab66.htm)|  Saves shared coordinates changes back to the linked document.   
...
![Public method](../icons/pubMethod.gif)| [Unload](83f4add7-1c0a-ddfa-b8ab-5be6df0f28a2.htm)|  Unloads the Revit link.   
![Public method](../icons/pubMethod.gif)| [UnloadLocally](2b12bdb3-1505-960c-7cdb-e41a1295ff60.htm)|  Unloads a Revit link for the current user only.   
