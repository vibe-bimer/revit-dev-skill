...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.htm) [Autodesk.Revit.DB.StructureLoadBase](4130f6dc-1963-2105-d85b-e08a7c34af8b.htm) Autodesk.Revit.DB.StructureLineLoad
...
![Public property](../icons/pubProperty.gif)| [EndPoint](55965bc2-8cc9-1609-2a9a-0566e478d97d.htm)|  Returns the three dimensional location of the end point for the line load.   
![Public property](../icons/pubProperty.gif)| [ForceVector1](50cbbc07-492f-b5f3-2753-1da47d52a8db.htm)|  The force vector applied to the start point of the line load, oriented according to OrientTo setting.   
![Public property](../icons/pubProperty.gif)| [ForceVector2](3b7d9168-aaa1-9efa-cc74-d384736e62c7.htm)|  The force vector applied to the end point of the line load, oriented according to OrientTo setting.   
...
![Public property](../icons/pubProperty.gif)| [IsProjected](482ec1fe-b5f4-75fb-2f17-440a6170aa37.htm)|  Indicates if the load is projected.   
...
![Public property](../icons/pubProperty.gif)| [IsUniform](e315fe82-508c-b64e-0f9a-4863596544f2.htm)|  Indicates if the load is uniform.   
...
![Public property](../icons/pubProperty.gif)| [MomentVector1](0094b002-656b-9c6b-2a9c-9a4d9eb97705.htm)|  The moment vector applied to the start point of the line load, oriented according to OrientTo setting.   
![Public property](../icons/pubProperty.gif)| [MomentVector2](ca5f8ab4-f017-81f7-46b9-de5154beaa70.htm)|  The moment vector applied to the end point of the line load, oriented according to OrientTo setting.   
...
![Public property](../icons/pubProperty.gif)| [StartPoint](77e175b5-7495-7a20-98fc-6aa5706a7687.htm)|  Returns the three dimensional location of the start point for the line load.   
...
![Public method](../icons/pubMethod.gif)| [GetCurve](9c5b8a89-b69e-63a3-b93e-8ee058e92874.htm)|  Returns curve that define geometry of the line load.   
...
![Public method](../icons/pubMethod.gif)![Static member](../icons/Static.gif)| [IsCurveInsideHostBoundaries](4bdb0447-3312-6ce7-08a6-f9a8de84ab3e.htm)|  Indicates if the curve is inside panel's boundaries or on panel's edges or if the curve is on the member's curve.   
...
![Public method](../icons/pubMethod.gif)![Static member](../icons/Static.gif)| [IsValidHostId](f294365b-5eee-57c0-ad6a-cbdd7bd7637f.htm)|  Indicates if the provided host id can host line loads The document containing both the host and the load The id of the analytical element that is about to host a line load True if a line load can be placed on the input host id   
...
![Public method](../icons/pubMethod.gif)| [SetCurve](2066b893-dc5e-7082-adc2-0fef5e397b6e.htm)|  Sets the curve for the line load.   
...
![Public method](../icons/pubMethod.gif)| [SetPoints](41589a19-523d-ab5f-d72e-4e3bd7bc020d.htm)|  Sets start and end point of the line load.   
