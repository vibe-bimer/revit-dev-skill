...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.htm) [Autodesk.Revit.DBSpatialElementCalculationLocation](f4fed5e0-0964-a973-c8f5-7beb046a2849.htm) Autodesk.Revit.DBSpatialElementFromToCalculationPoints
...
![Public property](../icons/pubProperty.gif)| [FromPosition](45dfa54d-baaf-e72f-4216-21c2034fe4f0.htm)|  The "from" position of spatial element connecting calculation point.   
...
![Public property](../icons/pubProperty.gif)| [MarkerPosition](11e13d93-8417-5f44-b33f-3f2ac4169d59.htm)|  The position of the spatial element calculation location marker. (Inherited from [SpatialElementCalculationLocation](f4fed5e0-0964-a973-c8f5-7beb046a2849.htm))  
...
![Public property](../icons/pubProperty.gif)| [ToPosition](128045fd-8cd1-b9e2-2add-28f92a250876.htm)|  The "to" position of spatial element connecting calculation point.   
...
![Public method](../icons/pubMethod.gif)| [Flip](7c873a16-4dcd-3a46-6b11-895d4ba48dc8.htm)|  flip the direction of the "from" and "to" points   
...
![Public method](../icons/pubMethod.gif)| [IsAcceptableFromPosition](4ab4d035-f4cc-1a33-4bd6-77709007c8ff.htm)|  Checks whether a given "from" position is valid.   
![Public method](../icons/pubMethod.gif)| [IsAcceptableToPosition](b18e836c-0ec0-ad03-1fe5-4df43e2b6ad3.htm)|  Checks whether a given "to" position is valid.   
...
![Public method](../icons/pubMethod.gif)| [MakeFromPositionAcceptable](c873f350-1aab-cba7-19a0-27a66ad68784.htm)|  This function takes a potential "from" point and converts it to be a similar point on the opposite side of the family's host from the "to" point if necessary.   
![Public method](../icons/pubMethod.gif)| [MakeToPositionAcceptable](638f8627-4f0a-9873-5012-6f6aef4e2c66.htm)|  This function takes a potential "to" point and converts it to be a similar point on the opposite side of the family's host from the "from" point if necessary.   
