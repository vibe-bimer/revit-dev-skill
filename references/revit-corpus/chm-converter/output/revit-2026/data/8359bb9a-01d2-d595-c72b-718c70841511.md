...
#### Return Value
[CheckoutStatus](f6f6e300-5a37-7e44-7ee1-8dc0c016778a.htm) An indication of whether the element is unowned, owned by the current user, or owned by another user. 
Exception| Condition  
---|---  
