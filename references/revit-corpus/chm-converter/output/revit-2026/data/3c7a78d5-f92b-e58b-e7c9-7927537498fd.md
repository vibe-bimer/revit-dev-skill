...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.htm) [Autodesk.Revit.DBElementType](ffb18296-0448-559c-580c-7857cbcdc094.htm) Autodesk.Revit.DB.StructureRebarHookType
...
![Public property](../icons/pubProperty.gif)| [HookAngle](85af7224-b751-4c40-a5d5-5b4dc757f742.htm)|  The hook angle, measured in radians. Must be greater than 0.0174532925 (1 degree) and no more than PI (180 degree).   
...
![Public property](../icons/pubProperty.gif)| [StraightLineMultiplier](28ab6bf6-6aef-39d7-c9b7-98e16cdc02d2.htm)|  Multiplier of bar diameter. Used to compute a default hook length. The default hook length can be overridden by the RebarBarType class.   
![Public property](../icons/pubProperty.gif)| [Style](3a223d55-0f7e-aa63-7314-e8ad1cd525c9.htm)|  The hook may only be applied to shapes of the specified style.   
...
![Public method](../icons/pubMethod.gif)![Static member](../icons/Static.gif)| [Create](e113d22a-0e59-6642-e45d-2538a0d24bff.htm)|  Creates a new RebarHookType in a document.   
![Public method](../icons/pubMethod.gif)![Static member](../icons/Static.gif)| [CreateDefaultRebarHookType](83699313-9138-9a03-2a9a-8f7373fcd535.htm)|  Creates a new RebarHookType object with a default name.   
...
![Public method](../icons/pubMethod.gif)| [GetDefaultHookExtension](de092ae2-aed1-186b-a987-cf8e5a84cba6.htm)|  Computes the default hook length, which is equal to barDiameter * multiplier.   
...
![Public method](../icons/pubMethod.gif)| [GetHookExtensionLength](dac6ad67-c23a-c5f0-26ed-4590cbfbc275.htm)|  Computes the hook extension length based on current hook length   
...
![Public method](../icons/pubMethod.gif)| [IsOffsetLengthRequired](4a11667a-73c9-a7a7-83a7-799cc45df5c2.htm)|  Check whether hook offset length is required. remarks: If hook angle is no more than 90 degree, hook offset length is not meaningful. returns: True if hook offset length is required, otherwise false.   
