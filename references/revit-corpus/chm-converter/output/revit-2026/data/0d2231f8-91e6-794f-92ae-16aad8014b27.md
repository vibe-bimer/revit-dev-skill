...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.htm) [Autodesk.Revit.DBInstance](08603dd9-976d-a9fe-add7-2a8450b8006c.htm) Autodesk.Revit.DBFamilyInstance [Autodesk.Revit.DBAnnotationSymbol](b8ea2b7b-6d1c-d0d3-aaf3-b95003c385b8.htm) [Autodesk.Revit.DBMullion](88bcefd6-2d2d-1c7e-b630-ed252ae965b4.htm) [Autodesk.Revit.DBPanel](ad561307-a19c-9a8a-728d-5646e90b451b.htm)
...
![Public property](../icons/pubProperty.gif)| [CanFlipFacing](13991f6f-3eab-0efc-8d9d-c30bfc9b1ae5.htm)| Property to test whether the orientation of family instance facing can be flipped.  
![Public property](../icons/pubProperty.gif)| [CanFlipHand](dc405f3d-888f-2831-c14a-4ffc315795d7.htm)| Property to test whether the orientation of family instance hand can be flipped.  
![Public property](../icons/pubProperty.gif)| [CanFlipWorkPlane](b108f031-40e0-bb91-6408-69c4d045db5a.htm)| Identifies if the instance can flip its work plane.  
![Public property](../icons/pubProperty.gif)| [CanRotate](36f8d40d-6322-1cb8-a5e2-2215da9ce45e.htm)| Property to test whether the family instance can be rotated by 180 degrees.  
![Public property](../icons/pubProperty.gif)| [CanSplit](a5075af4-0664-ed10-8303-665f0024c30a.htm)| Identifies whether a particular family instance can be split at a point on it's defining curve (by [Split(Double)](8f32a065-ba3c-79c7-8141-63183b4cdece.htm)).  
...
![Public property](../icons/pubProperty.gif)| [ExtensionUtility](2ff87911-3c17-babc-781d-e2c68e62d4e9.htm)| Property to check whether the instance can be extended and return the interface for extension operation.  
![Public property](../icons/pubProperty.gif)| [FacingFlipped](85483f11-1f76-594b-d1cc-6acf8f4fc368.htm)| Property to test whether the orientation of family instance facing is flipped.  
![Public property](../icons/pubProperty.gif)| [FacingOrientation](989288ad-d81c-9ee6-4351-21daf93d9cf0.htm)| Property to get the orientation of family instance facing.  
...
![Public property](../icons/pubProperty.gif)| [HandFlipped](7065faa0-00ac-93f1-427b-88496c53235e.htm)| Property to test whether the orientation of family instance hand is flipped.  
![Public property](../icons/pubProperty.gif)| [HandOrientation](a11ec72c-2498-aaea-4b2e-2adac454856c.htm)| Property to get the orientation of family instance hand.  
![Public property](../icons/pubProperty.gif)| [HasSpatialElementCalculationPoint](eb1b4c8b-8b8a-1247-4150-b5d55231363b.htm)| Identifies if this instance has a single SpatialElementCalculationPoint used as the search point for Revit to identify if the instance is inside a room or space.  
![Public property](../icons/pubProperty.gif)| [HasSpatialElementFromToCalculationPoints](eef2d8ce-6070-d666-b03d-480ef87d04a3.htm)| Identifies if this instance has a pair of SpatialElementCalculationPoints used as the search points for Revit to identify if the instance lies between up to two rooms or spaces.  
![Public property](../icons/pubProperty.gif)| [Host](69f30141-bd3b-8bdd-7a63-6353d4d495f9.htm)| If the instance is contained within another element, this property returns the containing element. An instance that is face hosted will return the element containing the face.   
![Public property](../icons/pubProperty.gif)| [HostFace](e795508b-bb6a-4f76-e282-57aa6f7074e5.htm)| Property to get the reference to the host face of family instance.  
![Public property](../icons/pubProperty.gif)| [HostParameter](bcf1a885-5015-0b87-dfe8-9109d499f4e7.htm)| If the instance is hosted by a wall, this property returns the parameter value of the insertion point of the instance along the wall's location curve, as long as the family of the instance isn't work plane based.  
...
![Public property](../icons/pubProperty.gif)| [Invisible](a60ebd06-8939-807f-9749-4510991bdff4.htm)| Property to test whether the family instance is invisible.  
...
![Public property](../icons/pubProperty.gif)| [IsSlantedColumn](14ca80b4-8cc8-2af7-3a72-db734b51eb79.htm)|  Indicates if the family instance is a slanted column.   
...
![Public property](../icons/pubProperty.gif)| [IsWorkPlaneFlipped](33d135c3-d887-c574-a049-f8abdcb01ded.htm)| Identifies if the instance's work plane is flipped.  
...
![Public property](../icons/pubProperty.gif)| [Location](847ff799-9b1b-0982-f55a-7273c55b196d.htm)| This property is used to find the physical location of an instance within project.(Overrides [ElementLocation](89438f4f-7e15-835a-0c66-d6adbc8dd00c.htm))  
![Public property](../icons/pubProperty.gif)| [MEPModel](34173003-db39-bfa9-fa59-f7b5ac8da794.htm)| Retrieves the MEP model for the family instance.  
![Public property](../icons/pubProperty.gif)| [Mirrored](20ab2f32-e3ca-8173-aac3-a03e998fd0ab.htm)| Property to test whether the family instance is mirrored. (only one axis is flipped)  
...
![Public property](../icons/pubProperty.gif)| [StructuralMaterialId](856b95a1-38c9-4d61-59cd-2844f7348984.htm)| Identifies the material that defines the instance's structural analysis properties.  
![Public property](../icons/pubProperty.gif)| [StructuralMaterialType](042b7922-53d9-d0ee-2f57-ce32cf5c5e4e.htm)| This property returns the physical material from which the instance is made.  
![Public property](../icons/pubProperty.gif)| [StructuralType](5072fbf4-e8e5-21df-d92e-476104c1418c.htm)| Provides the primary structural type of the instance, such as beam or column etc.  
![Public property](../icons/pubProperty.gif)| [StructuralUsage](52fe2ab8-d038-df14-fb12-e4f9c036dd7d.htm)| Provides the primary structural usage of the instance, such as brace, girder etc.  
![Public property](../icons/pubProperty.gif)| [SuperComponent](1dcf3123-c2ea-867a-7b9a-73173343121e.htm)| Property to get the super component of current family instance.  
![Public property](../icons/pubProperty.gif)| [Symbol](4157fff5-cde3-cbb7-1df8-03f77d64712f.htm)| Returns or changes the FamilySymbol object that represents the type of the instance.  
...
| Name| Description  
---|---|---  
![Public method](../icons/pubMethod.gif)| [AddCoping](a0fc20d1-36fc-a230-d41f-f7163184d328.htm)| Adds a coping (cut) to a steel beam.  
...
![Public method](../icons/pubMethod.gif)| [flipFacing](66eb8785-4225-509c-b6a3-0bf9fe1612b2.htm)| The orientation of family instance facing will be flipped. If it can not be flipped, return false, otherwise return true.  
![Public method](../icons/pubMethod.gif)| [FlipFromToRoom](ae1158c1-1fb0-0558-0ea4-e1cf76bb8a1e.htm)|  Flips the settings of "From Room" and "To Room" for the door or window instance.   
![Public method](../icons/pubMethod.gif)| [flipHand](c31b55a1-ce2e-a86c-ede0-21a883e7d4e4.htm)| The orientation of family instance hand will be flipped. If it can not be flipped, return false, otherwise return true.  
![Public method](../icons/pubMethod.gif)| [GetCopingIds](6886b519-4a44-373f-59ab-4ceee51dd096.htm)| Lists the elements currently used as coping cutters for this element.  
...
![Public method](../icons/pubMethod.gif)| [GetFamilyPointPlacementReferences](59db15da-7e87-a85f-bacf-e8a636d17022.htm)| Returns the Point Placement References for the Family Instance.  
...
![Public method](../icons/pubMethod.gif)| [GetOriginalGeometry](d28a0880-bff8-1acc-ddf1-ce3205f2e8b3.htm)|  Returns the original geometry of the instance, before the instance is modified by joins, cuts, coping, extensions, or other post-processing.  
...
![Public method](../icons/pubMethod.gif)| [GetReferenceByName](d44a95cc-f2c7-1fa9-9180-fefed6d70ed6.htm)|  Gets the family instance reference corresponding to the named reference plane in the instance's family.   
![Public method](../icons/pubMethod.gif)| [GetReferenceName](aaf6b45c-9139-b984-b824-2888ca32a95a.htm)|  Gets the name of the reference plane in the family corresponding to the given family instance reference.   
![Public method](../icons/pubMethod.gif)| [GetReferences](a8a7dc74-db8e-a7b6-a9c8-869397cca6b4.htm)|  Gets family instance references corresponding to the reference planes or reference lines of the given reference type in the instance's family.   
![Public method](../icons/pubMethod.gif)| [GetReferenceType](0405fced-1ac6-a6a9-9f59-21eb81ca2241.htm)|  Gets the type of the reference plane or reference line in the instance's family corresponding to the given family instance reference.   
![Public method](../icons/pubMethod.gif)| [GetSpatialElementCalculationPoint](433caf59-49b1-97df-38ac-8f01a620bef5.htm)| Gets the location of the calculation point for this instance.  
![Public method](../icons/pubMethod.gif)| [GetSpatialElementFromToCalculationPoints](21810873-d413-f6e4-ca33-d2ee4e93643e.htm)| Gets the locations for the calculation points for this instance.  
![Public method](../icons/pubMethod.gif)| [GetSubComponentIds](be37702c-1dcd-bc14-aa35-45f06f20210a.htm)| Gets the sub component ElementIds of the current family instance.  
...
![Public method](../icons/pubMethod.gif)| [GetSweptProfile](9bc9e2db-5ef1-8264-1426-01f4a6081844.htm)| Gets the object that describes the profile that is swept along the driving curve for this instance.  
...
![Public method](../icons/pubMethod.gif)| [HasModifiedGeometry](0f1f1713-8013-2f62-6e84-41749e1dcc95.htm)| Identifies if the geometry of this FamilyInstance has been modified from the automatically generated default.  
...
![Public method](../icons/pubMethod.gif)| [HasSweptProfile](dbbd4aa9-720b-3a1c-3085-7b94b6d73b58.htm)| Indicates if this instance can be represented as a swept profile.  
...
![Public method](../icons/pubMethod.gif)| [RemoveCoping](c0ccd04c-f952-011f-4b0f-25862792d619.htm)| Removes a coping (cut) from a steel beam.  
![Public method](../icons/pubMethod.gif)| [rotate](634dc711-7d00-a176-9c61-c53c27c89849.htm)| The family instance will be flipped by 180 degrees. If it can not be rotated, return false, otherwise return true.  
![Public method](../icons/pubMethod.gif)| [SetCopingIds](751280c8-4507-4837-add9-f6a83a1997fe.htm)|   
...
![Public method](../icons/pubMethod.gif)| [Split](8f32a065-ba3c-79c7-8141-63183b4cdece.htm)| Splits the family instance element at a point on its defining curve.  
