...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.htm) Autodesk.Revit.DB.StructureAreaReinforcement
...
| Name| Description  
---|---|---  
![Public property](../icons/pubProperty.gif)| [AdditionalBottomCoverOffset](dca7d7af-c539-7712-9f12-f2a16fd160d6.htm)|  Additional offset from the bottom or interior cover reference.   
![Public property](../icons/pubProperty.gif)| [AdditionalTopCoverOffset](f48b73e5-5690-0a18-ee73-fc2d63ab201f.htm)|  Additional offset from the top or exterior cover reference.   
![Public property](../icons/pubProperty.gif)| [AreaReinforcementType](c653d882-ddde-c6bf-806d-add2df555275.htm)|  Retrieves the type of the Area Reinforcement.   
...
![Public property](../icons/pubProperty.gif)| [Direction](7ff9e4ed-e3e9-4bf6-b306-be10c3854d93.htm)|  Retrieve the Major Direction of the Area Reinforcement.   
...
![Public method](../icons/pubMethod.gif)![Static member](../icons/Static.gif)| [ConvertRebarInSystemToRebars](0b655f89-d5c2-eef1-8900-67601a478b1a.htm)|  Converts all RebarInSystem elements owned by the input AreaReinforcement to equivalent Rebar elements.   
![Public method](../icons/pubMethod.gif)![Static member](../icons/Static.gif)| [Create(Document, Element, XYZ, ElementId, ElementId, ElementId)](3cf77bb2-3780-296e-0d19-698a289098eb.htm)|  Creates a new AreaReinforcement object based on a host boundary.   
![Public method](../icons/pubMethod.gif)![Static member](../icons/Static.gif)| [Create(Document, Element, IListCurve, XYZ, ElementId, ElementId, ElementId)](69267708-f0ad-3fd5-2018-fa624e763fa5.htm)|   
...
![Public method](../icons/pubMethod.gif)| [GetBoundaryCurveIds](75225104-99db-98f2-d407-6ee8f48ad9ae.htm)|  Retrieves the set of curves forming the boundary of the Area Reinforcement.   
...
![Public method](../icons/pubMethod.gif)| [GetHostId](f01b201e-507f-0100-6d58-de49f981a449.htm)|  The element that contains the Area Reinforcement.   
![Public method](../icons/pubMethod.gif)| [GetLayerDirection](bccd4ced-ea99-d3ba-0865-7fd8f8466d29.htm)|  Gets the direction of the layer. The lines are distributed along this direction.   
![Public method](../icons/pubMethod.gif)| [GetLineFromLayerAtIndex](8fa3c4da-89e0-28a5-d6dc-30f675dbb04b.htm)|  Gets the line from the desired layer at the specified index.   
...
![Public method](../icons/pubMethod.gif)| [GetMovedLineTransform](d07d2b3b-98ae-6ede-cc91-2d0bde1a4044.htm)|  Returns a transform representing the movement of the line relative to its default position along the direction of the desired layer.   
![Public method](../icons/pubMethod.gif)| [GetNumberOfLines](dff33b0e-1669-d318-5225-bd8472529eee.htm)|  Gets the number of lines on the specified layer. It also counts the excluded ones.   
...
![Public method](../icons/pubMethod.gif)| [GetRebarInSystemIds](164ad9af-4034-ca8b-d7f6-2e108becf7e1.htm)|  Returns the ids of the RebarInSystem elements owned by the AreaReinforcement element.   
...
![Public method](../icons/pubMethod.gif)| [IsLayerActive](547599ea-6b67-5d1e-7486-207e2764df70.htm)|  Identifies if the layer is active or not.   
![Public method](../icons/pubMethod.gif)| [IsLineIncluded](8ee8ebea-8c10-9feb-c76d-735d5ade33a0.htm)|  Checks whether the line from the desired layer at the specified position is included or not.   
...
![Public method](../icons/pubMethod.gif)| [IsUnobscuredInView](e68d430f-1cd3-be82-f495-438876dac18b.htm)|  Checks if Area Reinforcement is shown unobscured in a view.   
...
![Public method](../icons/pubMethod.gif)| [MoveLine](4fe8818c-3647-3e08-3bad-34452230ee1a.htm)|  This method applies the translation to the line from the desired layer, at the specified position. If the line was already moved, the method will concatenate the translation with the existing movement. The line will be translated only along the direction of the specified layer.   
...
![Public method](../icons/pubMethod.gif)![Static member](../icons/Static.gif)| [RemoveAreaReinforcementSystem](497ef418-b0cc-e0a2-34d1-67ef49274801.htm)|  Deletes the specified AreaReinforcement, and converts its RebarInSystem elements to equivalent Rebar elements.   
![Public method](../icons/pubMethod.gif)| [ResetMovedLineTransform](b44bf1dd-1cdb-50e2-59ab-b7894566019d.htm)|  Reset the transformation representing the movement of the line relative to its default position along the direction of the specified layer. The moved line transform will be set to Identity.   
...
![Public method](../icons/pubMethod.gif)| [SetLayerActive](47b31cd0-84ba-13e3-4a6d-66a3356d3b75.htm)|  Sets if the desired layer is active or not.   
![Public method](../icons/pubMethod.gif)| [SetLineIncluded](c735a91d-97a6-7944-1456-4fa495ac1609.htm)|  Sets if the line from desired layer at the specified position is included or not.   
![Public method](../icons/pubMethod.gif)| [SetUnobscuredInView](53acd3ec-3d4e-ea81-67af-de3512d5d875.htm)|  Sets Area Reinforcement to be shown unobscured in a view.   
