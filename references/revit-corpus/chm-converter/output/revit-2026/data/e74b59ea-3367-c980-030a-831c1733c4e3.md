...
This property is used to retrieve the default union fitting of the MEP curve type, and can be  if there is no default value. Use [RoutingPreferenceManager](a8300b97-72a6-beb5-733b-ec4cfea6c472.htm) to set this property for PipeType MEPCurves. 
#### Reference
