...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.htm) Autodesk.Revit.DB.StructureRebarInSystem
...
![Public method](../icons/pubMethod.gif)| [CanApplyPresentationMode](2507e69f-fa82-b92e-f15f-8e841dbf7345.htm)|  Checks if a presentation mode can be applied for this rebar in the given view.   
...
![Public method](../icons/pubMethod.gif)| [CanEditIndividualBars](f7753081-b760-9756-c38c-5cd214c4a768.htm)|  Checks if individual bars can be moved, excluded or included.   
...
![Public method](../icons/pubMethod.gif)| [ClearPresentationMode](7a085528-57ea-ea2a-7e30-0f699745758f.htm)|  Sets the presentation mode for this rebar set to the default (either for a single view, or for all views).   
...
![Public method](../icons/pubMethod.gif)| [DoesBarExistAtPosition](acd26ed2-3b9f-b240-04fe-e4da3dd14d66.htm)|  Checks whether a bar is included at the specified position.   
...
![Public method](../icons/pubMethod.gif)| [FindMatchingPredefinedPresentationMode](d479c5d6-532a-8f63-b2da-e51bb5239d64.htm)|  Determines if there is a matching RebarPresentationMode for the current set of selected hidden and unhidden bars assigned to the given view.   
![Public method](../icons/pubMethod.gif)| [GetBarIndexFromReference](96d5460c-a1e5-bf9b-54de-8c3fd9a78e3c.htm)|  Given a reference that represents a part of a bar, this method will return the bar index.   
![Public method](../icons/pubMethod.gif)| [GetBarPositionTransform](63195c82-5b20-91bd-9836-f259a1373418.htm)|  Return a transform representing the relative position of any individual bar in the set.   
![Public method](../icons/pubMethod.gif)| [GetBendData](4e97f9d9-2810-6573-9389-120d1edbd9c1.htm)|  Gets the RebarBendData, containing bar and hook information, of the instance.   
![Public method](../icons/pubMethod.gif)| [GetCenterlineCurves](1feb6854-6d32-e08c-1f90-21ffecb36f1b.htm)|  A chain of curves representing the centerline of the rebar.   
...
![Public method](../icons/pubMethod.gif)| [GetDistributionPath](c659fd9d-0cbc-0340-b364-02b0a082d2de.htm)|  The distribution path of a rebar set.   
...
![Public method](../icons/pubMethod.gif)| [GetHookTypeId](3365b4f5-7a75-d891-8a3b-6ecb922d3ff2.htm)|  Get the id of the RebarHookType to be applied to the rebar.   
![Public method](../icons/pubMethod.gif)| [GetHostId](fe7a895a-5ea3-64ba-a997-dead0c206d5a.htm)|  The element that contains the rebar.   
...
![Public method](../icons/pubMethod.gif)| [GetMovedBarTransform](2566be75-c675-6b5d-ed4b-3ff30a2ad7c4.htm)|  Returns a transform representing the movement of the bar relative to its default position along the distribution path.   
...
![Public method](../icons/pubMethod.gif)| [GetPresentationMode](6fd30c59-4218-7dcf-ddf8-494d04d98744.htm)|  Gets the presentaion mode for this rebar set when displayed in the given view.   
![Public method](../icons/pubMethod.gif)| [GetReinforcementRoundingManager](4143079d-d390-cb24-df50-cf7ae57dca26.htm)|  Returns an object for managing reinforcement rounding override settings.   
...
![Public method](../icons/pubMethod.gif)| [GetTransformedCenterlineCurves](f6064020-988b-b5b4-08ae-0db25f0a0868.htm)|  A chain of curves representing the centerline of the rebar.   
...
![Public method](../icons/pubMethod.gif)| [HasPresentationOverrides](0bd7f298-e69a-1179-820f-47fd589a2269.htm)|  Identifies if this RebarInSystem has overridden default presentation settings for the given view.   
![Public method](../icons/pubMethod.gif)| [IsBarHidden](8fa04d15-3891-4fe1-fa79-390a927d0d87.htm)|  Identifies if a given bar in this rebar set is hidden in this view.   
...
![Public method](../icons/pubMethod.gif)| [IsRebarInSection](7c479fff-51db-8053-a13b-0cfc87e2968d.htm)|  Identifies if this RebarInSystem is cut by the view plane of the given view.   
![Public method](../icons/pubMethod.gif)| [IsUnobscuredInView](ec52158a-a6df-dc13-545e-9543854728ad.htm)|  Checks if this rebar element is shown unobscured in a view.   
...
![Public method](../icons/pubMethod.gif)| [MoveBarInSet](abcc4709-c7cc-824b-1dcc-66ddb7b91aad.htm)|  This method applies the transformation matrix to the rebar bar at the desired position in the rebar set. If the bar was already moved, the method will concatenate the transformation matrix with the existing movement.   
...
![Public method](../icons/pubMethod.gif)| [ResetMovedBarTransform](1597340c-e5cc-3aec-4801-19a03b1ba487.htm)|  Reset the transformation representing the movement of the bar relative to its default position along the distribution path. The moved bar transform will be set to Identity.   
![Public method](../icons/pubMethod.gif)| [SetBarHiddenStatus](ded6fe15-74c8-04b0-880a-17bf2b09333f.htm)|  Sets the bar in this rebar set to be hidden or unhidden in the given view.   
![Public method](../icons/pubMethod.gif)| [SetBarIncluded](58132506-c018-6563-21dd-202f3327344f.htm)|  Sets if the bar at the desired index is included or not.   
...
![Public method](../icons/pubMethod.gif)| [SetPresentationMode](a4812768-85b2-df53-d43a-0c5d3688c295.htm)|  Sets the presentation mode for this rebar set when displayed in the given view.   
![Public method](../icons/pubMethod.gif)| [SetUnobscuredInView](445262e9-8299-eedd-3cf0-2131d8791529.htm)|  Sets RebarInSystem element to be shown unobscured in a view.   
