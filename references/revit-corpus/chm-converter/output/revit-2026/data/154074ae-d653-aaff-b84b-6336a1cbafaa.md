...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.htm) Autodesk.Revit.DBBasePoint
...
![Public property](../icons/pubProperty.gif)| [Clipped](e93c4d28-5bbc-9619-8313-fba01852a8bc.htm)|  Clipped state of the survey point (shared BasePoint). Change its state to clipped or unclipped, depending on how you want to move the survey point. To move the survey coordinate system in relation to the model, move the clipped survey point. To change the survey point to another location in the survey coordinate system, move the unclipped survey point. For project base point (non-shared BasePoint), this property will always return false. Trying to set the property will get an InvalidOperationException.   
...
![Public property](../icons/pubProperty.gif)| [IsShared](c4beb95c-34c9-0a9c-05a0-562bd0c98b81.htm)|  Indicates whether the BasePoint is shared. The project's survey point is a BasePoint which is shared.   
...
![Public property](../icons/pubProperty.gif)| [Position](1e5f8f39-9603-13bd-75ac-963eae3712eb.htm)|  Position of the BasePoint.   
![Public property](../icons/pubProperty.gif)| [SharedPosition](ad4095ac-ab51-3589-fcbd-c28b93bb3158.htm)|  Shared position of the BasePoint based on the active ProjectLocation of its belonging Document. To get the shared position under other ProjectLocations, please use ProjectLocation.GetProjectPosition(BasePoint.Position).   
...
![Public method](../icons/pubMethod.gif)![Static member](../icons/Static.gif)| [GetProjectBasePoint](fa70b69b-0339-15d9-7549-fafdb442f756.htm)|  Gets the project base point for the document.   
...
![Public method](../icons/pubMethod.gif)![Static member](../icons/Static.gif)| [GetSurveyPoint](044d6e50-c766-ae07-0e2d-e1f1e69391be.htm)|  Gets the survey point for the document.   
