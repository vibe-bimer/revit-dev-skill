...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.htm) [Autodesk.Revit.DBElementType](ffb18296-0448-559c-580c-7857cbcdc094.htm) Autodesk.Revit.DBMEPSystemType [Autodesk.Revit.DB.MechanicalMechanicalSystemType](2a746a28-9a28-5e1e-0a9d-b05d6b72376b.htm) [Autodesk.Revit.DB.PlumbingPipingSystemType](b0fe0b71-3b6c-85f0-8279-e93505e82529.htm)
...
| Name| Description  
---|---|---  
![Public property](../icons/pubProperty.gif)| [Abbreviation](6f21688c-b2b7-ad78-70a1-3f1de36eab18.htm)|  Identifies the abbreviation, the short name, for the system type   
...
![Public property](../icons/pubProperty.gif)| [CalculationLevel](76631989-d84f-3954-8743-f42b58ba4f43.htm)|  Identifies the calculation level for the system type.   
...
![Public property](../icons/pubProperty.gif)| [FillColor](1b4309e7-bdf4-807a-a13a-6dcef6a94b50.htm)|  Indicates the color that should override the fill color for all components in the system.   
![Public property](../icons/pubProperty.gif)| [FillPatternId](cc5413da-3984-5580-8303-70d790118cf3.htm)|  Indicates the fill pattern id that should override the fill pattern id for all components in the system.   
![Public property](../icons/pubProperty.gif)| [FillVisible](a16ccaf8-461b-226f-c40a-4956c69b36f8.htm)|  Indicates the visibility of the fill pattern for all components in the system.   
...
![Public property](../icons/pubProperty.gif)| [LineColor](83e01a4d-d51e-42bf-fe18-7c5856fe5c6e.htm)|  Indicates the color that should override the line color for all components in the system.   
![Public property](../icons/pubProperty.gif)| [LinePatternId](99830c67-ba7a-e28b-0d65-18b57c7f93af.htm)|  Indicates the line pattern id that should override the line pattern id for all components in the system.   
![Public property](../icons/pubProperty.gif)| [LineWeight](605a0923-f8f1-7e76-d836-cd4cf427a5e2.htm)|  Indicates the weight that should override the line weight for all components in the system.   
...
![Public property](../icons/pubProperty.gif)| [MaterialId](8da78a66-2b7d-2231-a112-64cf1cee6c19.htm)|  Indicates the material id that should override the material for all components in the system.   
...
![Public property](../icons/pubProperty.gif)| [SystemClassification](be329290-0ca0-b6a6-85f8-d9e35be028f1.htm)|  Identifies the classification for the system type   
