...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.htm) Autodesk.Revit.DBStartingViewSettings
...
![Public property](../icons/pubProperty.gif)| [ViewId](dd5cd741-e211-9bb3-666c-ee056520c2d9.htm)|  Indicates the specific view that will be opened when the model is loaded. InvalidElementId indicates that no view has been specified. In that case, Revit will open the last views that were open at the time the file was saved.   
...
![Public method](../icons/pubMethod.gif)![Static member](../icons/Static.gif)| [GetStartingViewSettings](84788ba0-4edd-5483-eb22-898dbc21520b.htm)|  Returns the starting view settings for the specified document.   
...
![Public method](../icons/pubMethod.gif)| [IsAcceptableStartingView](7118b9ba-d29e-78d2-9293-705de4726980.htm)|  Checks whether the given Id is an acceptable starting view. InvalidElementId corresponds to "Last Viewed" and is therefore also acceptable.   
