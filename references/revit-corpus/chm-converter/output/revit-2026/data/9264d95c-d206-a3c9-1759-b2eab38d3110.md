...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.htm) [Autodesk.Revit.DBBaseArray](d7f9a542-0333-2e10-83a2-98afcee00b80.htm) Autodesk.Revit.DBRadialArray
...
![Public property](../icons/pubProperty.gif)| [Label](816d60e1-d4ea-cda1-4736-aa5f7d05594a.htm)| The family parameter label of the BaseArray.(Inherited from [BaseArray](d7f9a542-0333-2e10-83a2-98afcee00b80.htm))  
...
![Public property](../icons/pubProperty.gif)| [Name](4eecb0d1-7633-86b7-d95c-42a4362f0b2c.htm)| Get and Set the Name property(Inherited from [BaseArray](d7f9a542-0333-2e10-83a2-98afcee00b80.htm))  
![Public property](../icons/pubProperty.gif)| [NumMembers](d2367107-a551-96ce-19b2-b96ef41678a7.htm)| Retrieves or changes the number of arrayed members. Array placeholder members in the family environment are not counted.(Overrides [BaseArrayNumMembers](66183f2d-7dee-631d-3dcb-0d484d134c91.htm))  
...
![Public method](../icons/pubMethod.gif)![Static member](../icons/Static.gif)| [ArrayElementsWithoutAssociation](9a06b1f5-4894-09a8-cd90-b2ca8814511a.htm)|   
![Public method](../icons/pubMethod.gif)![Static member](../icons/Static.gif)| [ArrayElementWithoutAssociation](248559b9-c065-e05b-e8df-d60e8ed5e47d.htm)|  Creates a new radial array from a single element based on an input rotation axis.   
...
![Public method](../icons/pubMethod.gif)| [GetCopiedMemberIds](f85c5b4b-2835-8f8b-fccf-3f690c1806b9.htm)| Retrieves the copied member ids from the array. The first item in an array contains the original elements from which the array was created. All other items in the array are copies.(Overrides [BaseArrayGetCopiedMemberIds](ce0d8197-a99f-0ef2-32a8-51d4cc2aa101.htm))  
...
![Public method](../icons/pubMethod.gif)![Static member](../icons/Static.gif)| [GetMinimumSize](f5f9796e-020b-560c-9a53-02e897849658.htm)|  Returns the minimum size for a radial array based on the document.   
...
![Public method](../icons/pubMethod.gif)| [GetNumberOfMembersIncludingPlaceholders](290f5c27-d9b4-f61b-7dec-74f5a95fd408.htm)|  Returns the number of items in an array, including placeholder items in families.   
...
![Public method](../icons/pubMethod.gif)| [GetOriginalMemberIds](463da165-3dc6-315a-d2d7-95118d32445a.htm)| Retrieves the ids for the original elements from which the array was created. These elements form the first item in the array.(Overrides [BaseArrayGetOriginalMemberIds](8c15fb58-a534-abd4-0715-841ea1c1447f.htm))  
...
![Public method](../icons/pubMethod.gif)![Static member](../icons/Static.gif)| [IsRotationAngleValid](36ec5016-3a12-dbe9-1d5d-e0c723b978f3.htm)|  This indicates whether the input angle is valid.   
![Public method](../icons/pubMethod.gif)![Static member](../icons/Static.gif)| [IsValidNumberOfMembers](92179d4c-59e2-74a2-df6e-aa6423d7a81b.htm)|  This indicates whether the input count is a valid size for an array based on the document.   
