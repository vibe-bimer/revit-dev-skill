...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.htm) Autodesk.Revit.DB.StructureRebarContainer
...
![Public property](../icons/pubProperty.gif)| [ItemsCount](1ef0af6d-ca4a-9a2e-8095-f86d20286c59.htm)|  The count of Items in this Rebar Container.   
...
![Public property](../icons/pubProperty.gif)| [PresentItemsAsSubelements](a949781c-f4be-54bf-6f74-52dff40b28f7.htm)|  Identifies if Items should be presented in schedules and tags as separate subelements.   
![Public property](../icons/pubProperty.gif)| [ScheduleMark](45faac1a-a8ec-2df3-4cfd-8d49b98ee92b.htm)|  The Schedule Mark parameter. On creation, the Schedule Mark is set to a value that is unique to the host, but it can be set to any value.   
...
![Public method](../icons/pubMethod.gif)| [AppendItemFromRebar](b7e0adc7-0f2e-af1e-9224-3f1ae4067e3c.htm)|  Appends an Item to the RebarContainer. Fills its data on base of the Rebar. Will throw exception if given rebar is not shape driven. Will throw exception if given rebar has moved bars in set.   
![Public method](../icons/pubMethod.gif)| [AppendItemFromRebarShape](292aade1-0459-1a6a-9bd3-715e8bb634df.htm)|  Appends an Item to the RebarContainer. Fills its data on base of the Rebar.   
...
![Public method](../icons/pubMethod.gif)| [CanApplyPresentationMode](4320a85e-3b48-719a-ec2e-ee74991c2dc2.htm)|  Checks if a presentation mode can be applied for this RebarContainer in the given view.   
...
![Public method](../icons/pubMethod.gif)| [ClearItems](4ba16a7e-eaaf-510b-2527-ce32948972bc.htm)|  Clears all the Items stored in this Rebar Container element.   
![Public method](../icons/pubMethod.gif)| [Contains](ed75fef3-8c01-c440-a1ca-db20914712fa.htm)|  Checks if the RebarContainer has this item as one of its members.   
![Public method](../icons/pubMethod.gif)![Static member](../icons/Static.gif)| [Create](48da4e91-7ce6-5636-458f-bc7287ad98b0.htm)|  Creates a new instance of a Rebar Container element within the project.   
...
![Protected method](../icons/protMethod.gif)| [GetBasicIEnumerator](53f23133-175e-f3ce-f58d-a77358ca5129.htm)| Returns an enumerator that iterates through a collection.  
...
![Public method](../icons/pubMethod.gif)| [GetEnumerator](f4f0511f-3ff8-d69f-a457-af5be5b91679.htm)| Returns an enumerator that iterates through a collection.  
...
![Public method](../icons/pubMethod.gif)| [GetHostId](da5694c7-b1bb-6155-47f9-93b0b61776ea.htm)|  The element that contains the rebar.   
![Public method](../icons/pubMethod.gif)| [GetItem](d591f494-7c8c-a8ef-1a6a-31dc8dbc2ee4.htm)|  Gets the item stored in the RebarContainer at the associated index.   
...
![Public method](../icons/pubMethod.gif)| [GetParametersManager](276727c8-b3fc-d31c-a7f9-bac1871a20b1.htm)|  Returns an object used to manage parameters of the Rebar Container.   
...
![Public method](../icons/pubMethod.gif)| [GetRebarContainerIterator](e3368385-4e90-a01e-9335-18d0bdc75790.htm)|  Returns a Rebar Container Iterator that iterates through the Rebar Container Items.   
![Public method](../icons/pubMethod.gif)| [GetReinforcementRoundingManager](5149cdb5-f393-6b9e-e101-0fc3384d1236.htm)|  Returns an object for managing reinforcement rounding override settings.   
...
![Public method](../icons/pubMethod.gif)| [HasPresentationOverrides](cc0e04ac-56a9-f1a5-cae8-9962b0aa60a4.htm)|  Identifies if any RebarContainerItem of this RebarContainer has overridden default presentation settings for the given view.   
...
![Public method](../icons/pubMethod.gif)| [IsItemHidden](0c86e348-7204-5953-4398-e6ee29bc79c1.htm)|  Identifies if a given RebarContainerItem is hidden in this view.   
...
![Public method](../icons/pubMethod.gif)| [IsUnobscuredInView](1a9453cc-db8c-bbcf-dd6c-5380b809df09.htm)|  Checks if this rebar container element is shown unobscured in a view.   
...
![Public method](../icons/pubMethod.gif)| [RemoveItem](a72cdb40-2bb0-47c2-d0da-acca1289099e.htm)|  Removes Item from the Rebar Container.   
...
![Public method](../icons/pubMethod.gif)| [SetHostId](affeac8e-7d19-ee94-4a29-3011ab93e8a0.htm)|  The element that contains the rebar.   
![Public method](../icons/pubMethod.gif)| [SetItemHiddenStatus](c2eccd30-4ff7-7d9c-7858-548fc7269505.htm)|  Sets the RebarContainerItem to be hidden or unhidden in the given view.   
![Public method](../icons/pubMethod.gif)| [SetUnobscuredInView](484d706c-e0df-473f-5427-f3eeac17eedc.htm)|  Sets this rebar container element to be shown unobscured in a view.   
