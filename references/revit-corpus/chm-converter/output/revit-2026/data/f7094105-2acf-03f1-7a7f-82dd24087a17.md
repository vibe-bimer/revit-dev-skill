...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.htm) Autodesk.Revit.DBFabricationConfiguration
...
| Name| Description  
---|---|---  
![Public method](../icons/pubMethod.gif)| [AncillaryExists](2042758d-e451-923e-82f8-c74a38f30409.htm)|  Checks to see if the specified ancillary exists.   
![Public method](../icons/pubMethod.gif)| [AreItemFilesLoaded](bdedf16d-79ae-abd0-9052-697366004b19.htm)|   
...
![Public method](../icons/pubMethod.gif)| [CanBeSwapped](a8effafa-42c2-10bf-dda3-9a435c4075a2.htm)|  Checks if the fabrication configuration can be swapped.   
...
![Public method](../icons/pubMethod.gif)| [CanUnloadItemFiles](eaece08e-f3cf-3bd6-489e-19d8cf8e8b1f.htm)|   
...
![Public method](../icons/pubMethod.gif)| [CheckConnectionsForAllFabricationParts](108f0f05-3b86-c983-aaa5-2e53b5ca9748.htm)|  Checks the connections for all fabrication parts in the current project. It will create reviewable warnings for all bad connections found. The checks are looking for bad alignments or gaps, incompatible connection types, mismatches of size, mismatches of shapes.   
![Public method](../icons/pubMethod.gif)| [CustomDataExists](3b4d7726-f4de-f10f-4a14-8cf4a3912a4d.htm)|  Checks to see if the specified custom data exists.   
![Public method](../icons/pubMethod.gif)| [DamperExists](3b6086d3-65f7-8b3f-51c8-d261ad0be933.htm)|  Checks to see if the specified damper exists.   
...
![Public method](../icons/pubMethod.gif)| [GetAllDampers](b856c588-2a9d-fd34-4d4d-21ba8fcc1343.htm)|  Gets all damper identifiers in the fabrication configuration.   
![Public method](../icons/pubMethod.gif)| [GetAllFabricationConnectorDefinitions](d694f14a-7afc-1f01-334a-94dd21985835.htm)|  Gets fabrication connector identifiers from the fabrication configuration, filtered by shape and domain.   
![Public method](../icons/pubMethod.gif)| [GetAllInsulationSpecifications](daaeb400-b013-36e5-f4f1-d697b668a712.htm)|  Gets all insulation specification identifiers in the fabrication configuration.   
![Public method](../icons/pubMethod.gif)| [GetAllLoadedItemFiles](2bc97834-4739-5bb2-83d5-c3ae296250ad.htm)|  Get list of all loaded fabrication item files.   
![Public method](../icons/pubMethod.gif)| [GetAllLoadedServices](834e34e3-1656-e0f4-b993-735712a3dba7.htm)|  Returns all the loaded fabrication services.   
![Public method](../icons/pubMethod.gif)| [GetAllMaterials](f8e1ab05-467f-6ee6-3103-052d27e8af74.htm)|  Gets all material identifiers in the fabrication configuration.   
![Public method](../icons/pubMethod.gif)| [GetAllPartCustomData](19f74ecb-a0c6-5541-126d-9191b9b6db4a.htm)|  Gets all possible fabrication part custom data identifiers.   
![Public method](../icons/pubMethod.gif)| [GetAllPartStatuses](0cd93d49-9295-cd01-dd68-3a7abe616690.htm)|  Gets all possible fabrication part status identifiers.   
![Public method](../icons/pubMethod.gif)| [GetAllServices](ce53c061-fce3-80f7-ca41-80846e3b2159.htm)|  Returns all fabrication services in the fabrication configuration.   
![Public method](../icons/pubMethod.gif)| [GetAllSpecifications](736406c3-c459-2fad-b966-7dc37f339b65.htm)|  Gets all specification identifiers in the fabrication configuration.   
![Public method](../icons/pubMethod.gif)| [GetAllUsedItemFiles](0c62a934-d041-14d6-dc54-bd99b8a67111.htm)|  Returns all the used fabrication item files. A fabrication item file is used if any fabrication parts in the model were created from it.   
![Public method](../icons/pubMethod.gif)| [GetAllUsedServices](4a7b444f-9a43-5188-5ee4-d13debe21eec.htm)|  Returns all the used fabrication services. A service is used if any fabrication part in the service is created by user.   
![Public method](../icons/pubMethod.gif)| [GetAncillaries](b224007e-150d-c5a1-c703-d7abb8a37d29.htm)|  Gets fabrication ancillaries of the specified type.   
![Public method](../icons/pubMethod.gif)| [GetAncillaryGroup](881dd623-3c7d-59e1-b19d-9f56e5f6d45a.htm)|  Gets the fabrication ancillary group of the specified fabrication ancillary identifier.   
![Public method](../icons/pubMethod.gif)| [GetAncillaryGroupName](2367e7e5-4c90-0473-cddc-0281093af660.htm)|  Gets the fabrication ancillary group and name for the specified fabrication ancillary identifier.   
![Public method](../icons/pubMethod.gif)| [GetAncillaryName](e9a3df25-b421-150f-649a-e9172f1f1706.htm)|  Gets the fabrication ancillary name for the specified fabrication ancillary identifier.   
![Public method](../icons/pubMethod.gif)| [GetDamperName](e84d23a2-0615-50a1-2802-746f74a51818.htm)|  Gets the damper name from its identifier.   
...
![Public method](../icons/pubMethod.gif)![Static member](../icons/Static.gif)| [GetFabricationConfiguration](041695a6-1434-bb23-6105-5783458b8ceb.htm)|  Gets the fabrication configuration element in the document.   
![Public method](../icons/pubMethod.gif)| [GetFabricationConfigurationInfo](3912030b-b1af-8856-2ace-f6ceeb369cec.htm)|  Gets the information about the fabrication configuration of the project.   
![Public method](../icons/pubMethod.gif)| [GetFabricationConnectorDomain](f02ed712-2e58-d96b-b807-02e0e3940087.htm)|  Gets the fabrication connector domain from its identifier.   
![Public method](../icons/pubMethod.gif)| [GetFabricationConnectorGroup](23aa9453-cc47-939b-c691-341f9b8bf3a6.htm)|  Gets the fabrication connector group from its identifier.   
![Public method](../icons/pubMethod.gif)| [GetFabricationConnectorName](eee278fa-1961-c38a-b1a7-df0af1472896.htm)|  Gets the fabrication connector name from its identifier.   
![Public method](../icons/pubMethod.gif)| [GetFabricationConnectorShape](c5054b58-4830-46b1-4337-801e5ca19054.htm)|  Gets the fabrication connector shape from its identifier.   
...
![Public method](../icons/pubMethod.gif)| [GetInsulationSpecificationAbbreviation](807829a2-4ad2-41ea-cf60-e125d7693dfe.htm)|  Gets insulation specification abbreviation.   
![Public method](../icons/pubMethod.gif)| [GetInsulationSpecificationGroup](dec6f45a-0b84-46c9-37a6-8dc9dbdc024e.htm)|  Gets the insulation specification group from its identifier.   
![Public method](../icons/pubMethod.gif)| [GetInsulationSpecificationName](63f50dfb-2da5-cb46-41b6-7524f6e4380c.htm)|  Gets the insulation specification name from its identifier.   
![Public method](../icons/pubMethod.gif)| [GetItemFolders](d283e079-1113-f185-e9c0-d40fada72391.htm)|  Gets a list of fabrication item folders in the fabrication item folder structure.   
![Public method](../icons/pubMethod.gif)| [GetMaterialAbbreviation](fc7879dd-dd2c-71f5-429b-b640d4ac20be.htm)|  Gets the abreviation of the material or the insulation or the double wall material.   
...
![Public method](../icons/pubMethod.gif)| [GetMaterialByGUID](a2bebe19-1cb3-7bfc-c19f-d17ee5e614b8.htm)|  Gets the material identifier by its GUID.   
![Public method](../icons/pubMethod.gif)| [GetMaterialGaugeByGUID](0dcb90fe-5bce-a212-05b0-b107060dd381.htm)|  Gets the material gauge identifier by its GUID and material identifier.   
![Public method](../icons/pubMethod.gif)| [GetMaterialGaugeGUID](8a8c3761-d5ee-15a5-abc0-659d62845c0c.htm)|  Gets the material gauge GUID by its material/gauge identifiers.   
![Public method](../icons/pubMethod.gif)| [GetMaterialGroup](51b9427d-cfef-30be-45cf-fb282212a9a5.htm)|  Gets material group from its identifier.   
![Public method](../icons/pubMethod.gif)| [GetMaterialGUID](b394287b-bfa2-2fc9-e457-6afb7fbf064c.htm)|  Gets the material GUID by its identifier.   
...
![Public method](../icons/pubMethod.gif)| [GetMaterialName](828e75ce-67c4-be63-65a0-d547c2541d21.htm)|  Gets material name from its identifier.   
...
![Public method](../icons/pubMethod.gif)| [GetPartCustomDataName](46f73ae4-794e-e195-4d52-47a7df0346c9.htm)|  Gets the custom data name from its identifier.   
![Public method](../icons/pubMethod.gif)| [GetPartCustomDataType](46ec095d-1c5a-54e9-3229-4aa6172a274f.htm)|  Gets the custom data type from its identifier. See FabricationCustomDataType enumerator.   
![Public method](../icons/pubMethod.gif)| [GetPartStatusDescription](70e3afea-50e2-5ff4-867d-c39094edbf65.htm)|  Gets the status description from its identifier.   
...
![Public method](../icons/pubMethod.gif)| [GetProfile](63e8bb2b-b53c-b0e1-995c-8d24428b824b.htm)|  Return the profile of the loaded fabrication configuration. Return empty string for global profile.   
![Public method](../icons/pubMethod.gif)| [GetService](428c7eb4-2dec-4038-3dd4-4dd2a1fd85bd.htm)|  Get the service based on the service identifier from the fabrication configuration in the current document.   
![Public method](../icons/pubMethod.gif)| [GetServiceByGUID](bf058c52-e36d-e8fd-f2c7-88a4d30ec3d6.htm)|  Gets the service identifier by its GUID.   
![Public method](../icons/pubMethod.gif)| [GetServiceGUID](bc7b8b27-7e65-06eb-4962-84302ea0e802.htm)|  Gets the service GUID by its identifier.   
![Public method](../icons/pubMethod.gif)| [GetServiceTypeName](70ab5511-d2f9-d818-d82b-33fd1016c361.htm)|  Gets the service type name.   
![Public method](../icons/pubMethod.gif)| [GetSpecificationAbbreviation](bcb23a34-ee26-0c8e-5d79-4b9e45a4d927.htm)|  Gets specification abbreviation.   
![Public method](../icons/pubMethod.gif)| [GetSpecificationByGUID](1c0d88ad-f1c0-ad43-1263-f66f52b587b6.htm)|  Gets the specification identifier by its GUID.   
![Public method](../icons/pubMethod.gif)| [GetSpecificationGroup](b3c66f8d-7aa8-ad2c-bfeb-6e69b7eb12b5.htm)|  Gets the specification group from its identifier.   
![Public method](../icons/pubMethod.gif)| [GetSpecificationGUID](6683f61e-3f39-91bb-857a-74d54f78154a.htm)|  Gets the specification GUID by its identifier.   
![Public method](../icons/pubMethod.gif)| [GetSpecificationName](7f3081d2-948e-af1a-ef49-8d6e04ae6090.htm)|  Gets the specification name from its identifier.   
...
![Public method](../icons/pubMethod.gif)| [GetUpdatedStraightsFromValidateConnections](710c220d-b82b-413b-7491-e9d633359713.htm)|  Get the set of element identifiers of fabrication part straights that were previously updated. If there were no straights were updated it will return an empty set of element identifiers.   
...
![Public method](../icons/pubMethod.gif)| [HasValidConfiguration](dc0b2e19-bd72-b15d-3752-a2ea09938b7c.htm)|  Checks whether a valid fabrication configuration has been set for the project.   
![Public method](../icons/pubMethod.gif)| [IsAncillaryKit](b4c6e352-3a70-eb07-84a1-2d107fb6da40.htm)|  Gets whether the specified fabrication ancillary identifier is an ancillary kit or not.   
...
![Public method](../icons/pubMethod.gif)| [LoadItemFiles](d7aa286a-d55d-46da-b654-0c175f433abc.htm)|   
![Public method](../icons/pubMethod.gif)| [LoadServices](893d7a24-0fd6-410f-2459-99c3b16fbfe0.htm)|   
![Public method](../icons/pubMethod.gif)| [LocateFabricationConnector](02a21b64-3880-17fa-6646-05ebe0c759fd.htm)|  Gets the fabrication connector identifiers by group and name, filtered by shape and domain.   
![Public method](../icons/pubMethod.gif)| [LocateInsulationSpecification](a3f54ebb-06df-0683-2541-984ed525476e.htm)|  Gets the insulation specification by group and name.   
![Public method](../icons/pubMethod.gif)| [LocateMaterial](d3466136-f845-f453-9456-9981cd4d4fdd.htm)|  Gets material by group and name.   
![Public method](../icons/pubMethod.gif)| [LocateSpecification](39c265d3-b467-4277-d3ad-78e1d1c31fe4.htm)|  Gets the specification identifier by group and name.   
...
![Public method](../icons/pubMethod.gif)| [PostReviewableWarningsForBadConnections](d9ca1df6-17ea-9dce-ec09-6d3d1627e119.htm)|  Reviewable warnings are created for all entries contained in the connection validation information.   
...
![Public method](../icons/pubMethod.gif)| [ReloadConfiguration](4a40d755-029f-5a44-b2a4-b4bb749eae52.htm)|  Reloads the fabrication configuration from its source fabrication configuration.   
...
![Public method](../icons/pubMethod.gif)| [SetServicesToLoad](bafcf7a1-c1c1-e908-9d80-31f71a7b6c86.htm)|   
![Public method](../icons/pubMethod.gif)| ToString| Returns a string that represents the current object.(Inherited from Object)  
![Public method](../icons/pubMethod.gif)| [UnloadItemFiles](3343cdd7-7050-0e6f-c294-936a3a9c7e03.htm)|   
![Public method](../icons/pubMethod.gif)| [UnloadServices](65e9d8c8-0371-8397-3a50-ec155e189999.htm)|   
![Public method](../icons/pubMethod.gif)| [ValidateConnectionsForAllFabricationParts](c514bccb-d434-8ea3-b0da-d2cd3a4d617d.htm)|  Validates all fabrication part connections in the current project. Invalid connections found will be added to the connection validation information class. The validation checks for bad alignments or gaps, incompatible connection types, mismatches of size, mismatches of shapes.   
Top
