...
Exception| Condition  
---|---  
[InvalidOperationException](9e715f03-3884-e539-4dd6-8d7545733adc.htm)|  Thrown when the current view sheet set is In-Session or the current view sheet set is unchanged.   
#### Reference
