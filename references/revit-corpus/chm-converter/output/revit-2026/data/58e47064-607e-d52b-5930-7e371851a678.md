...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.htm) [Autodesk.Revit.DBBaseArray](d7f9a542-0333-2e10-83a2-98afcee00b80.htm) Autodesk.Revit.DBLinearArray
...
![Public property](../icons/pubProperty.gif)| [NumMembers](f2ed4299-f623-dc05-6e95-f3bfd234d9ae.htm)| Retrieves or changes the number of arrayed members. Array placeholder members in the family environment are not counted.(Overrides [BaseArrayNumMembers](66183f2d-7dee-631d-3dcb-0d484d134c91.htm))  
...
![Public method](../icons/pubMethod.gif)![Static member](../icons/Static.gif)| [ArrayElementsWithoutAssociation](5c97b79a-6d6b-5f74-fa3f-c35fbc96d01c.htm)|   
![Public method](../icons/pubMethod.gif)![Static member](../icons/Static.gif)| [ArrayElementWithoutAssociation](260ee73e-2196-79a3-19ac-f942aafc44f4.htm)|  Creates a new linear array from a single element.   
...
![Public method](../icons/pubMethod.gif)| [GetCopiedMemberIds](1d424df0-983c-4ebd-b749-6bec157e30b5.htm)| Retrieves the copied member ids from the array. The first item in an array contains the original elements from which the array was created. All other items in the array are copies.(Overrides [BaseArrayGetCopiedMemberIds](ce0d8197-a99f-0ef2-32a8-51d4cc2aa101.htm))  
...
![Public method](../icons/pubMethod.gif)![Static member](../icons/Static.gif)| [GetMinimumSize](f90fe0c3-22c2-baee-a122-6958cc50c914.htm)|  Returns the minimum size for a linear array based on the document.   
...
![Public method](../icons/pubMethod.gif)| [GetNumberOfMembersIncludingPlaceholders](a8947a57-af78-20b3-abac-421fb9e2ca04.htm)|  Returns the number of items in an array, including placeholder items in families.   
...
![Public method](../icons/pubMethod.gif)| [GetOriginalMemberIds](99315d93-cf2a-8619-49de-0864a5b742cc.htm)| Retrieves the ids for the original elements from which the array was created. These elements form the first item in the array.(Overrides [BaseArrayGetOriginalMemberIds](8c15fb58-a534-abd4-0715-841ea1c1447f.htm))  
...
![Public method](../icons/pubMethod.gif)![Static member](../icons/Static.gif)| [IsElementArrayable](c7a9d13d-f660-659d-732b-13718d298e8a.htm)|  Indicates whether the input element is arrayable.   
...
![Public method](../icons/pubMethod.gif)![Static member](../icons/Static.gif)| [IsValidNumberOfMembers](a1f0d0cf-b0e0-a110-5d9f-d747f6761c92.htm)|  This indicates whether the input count is a valid size for an array based on the document.   
