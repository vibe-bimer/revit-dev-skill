...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.htm) [Autodesk.Revit.DBElementType](ffb18296-0448-559c-580c-7857cbcdc094.htm) Autodesk.Revit.DBMultiReferenceAnnotationType
...
![Public property](../icons/pubProperty.gif)| [DimensionStyleId](2849b4f5-70fd-747b-e31c-d286ee518645.htm)|  The dimension style which will be used by the child dimension of the multi-reference annotation.   
...
![Public property](../icons/pubProperty.gif)| [GroupTagHeads](c8bbdb4c-9c69-b4b8-7382-c3d9f54f380c.htm)|  Controls if parameter values for the annotation's references will be reported in one grouped tag head or if every reference will get its own tag head.   
...
![Public property](../icons/pubProperty.gif)| [ReferenceCategoryId](5d89b166-9eb2-924b-7c8b-ec41508825d0.htm)|  The category of elements to which this annotation applies.   
![Public property](../icons/pubProperty.gif)| [ShowDimensionText](48eb0247-c2f6-ea03-b347-f9d999662428.htm)|  Controls if text from the multi-reference annotation's dimension will be shown.   
![Public property](../icons/pubProperty.gif)| [TagTypeId](27b53b40-5506-9a4a-321a-cd8db9b09ceb.htm)|  The tag type which will be used by the child tag the multi-reference annotation.   
...
![Public method](../icons/pubMethod.gif)![Static member](../icons/Static.gif)| [CreateDefault](25edda1f-9be3-5f7e-2d3b-255293c08b2a.htm)|  Creates the first MultiReferenceAnnotationType element and adds it to the document.   
...
![Public method](../icons/pubMethod.gif)| [GetAllowedTagCategory](06cf5deb-d580-4ce1-f0fd-a17b5558b3c9.htm)|  Returns the category ID for the tag types which can be used by this multi-reference annotation type.   
...
![Public method](../icons/pubMethod.gif)| [IsAllowedDimensionStyle](d55188f4-3723-7444-8086-5c23e58333ed.htm)|  Checks if the dimension style can be used with multi-reference annotations.   
![Public method](../icons/pubMethod.gif)| [IsAllowedReferenceCategory](44d8f0d4-67f2-3c2a-0941-350401e9ec9b.htm)|  Checks if the reference category can be used with multi-reference annotations.   
![Public method](../icons/pubMethod.gif)![Static member](../icons/Static.gif)| [IsAllowedTagCategory](2bff739f-d084-8596-0633-28013e778e6c.htm)|  Returns true if tag types belonging to this category can be used with multi-reference annotation types.   
![Public method](../icons/pubMethod.gif)| [IsAllowedTagType](4f7f0cf5-ed38-ec2c-cfc9-7568b29a4601.htm)|  Checks if the tag type can be assigned to this multi-reference annotation type.   
