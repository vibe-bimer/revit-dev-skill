...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.htm) Autodesk.Revit.DBGroup
...
![Public property](../icons/pubProperty.gif)| [AttachedParentId](52a0655a-26fc-7f2b-17b1-5d48c75dea70.htm)|  Indicates the Id of the parent group this group is attached to.   
...
![Public property](../icons/pubProperty.gif)| [GroupType](d77ac466-dc1f-90cb-0b5f-d23fe88065d6.htm)| Get or set the type of the group.  
...
![Public property](../icons/pubProperty.gif)| [IsAttached](fe1c02cc-e67f-2049-8bef-1df2f26fe37d.htm)|  Indicates wether or not this group is attached to a parent group.   
...
![Public property](../icons/pubProperty.gif)| [Location](446dcaea-8792-b703-e0c2-e9e30cbadfd3.htm)| This property is used to find the physical location of a group within project.(Overrides [ElementLocation](89438f4f-7e15-835a-0c66-d6adbc8dd00c.htm))  
...
![Public method](../icons/pubMethod.gif)| [GetAvailableAttachedDetailGroupTypeIds](dd127374-e2c5-9c5e-3edd-c1b0ec60e30d.htm)|  Returns the attached detail groups available for this group type.   
...
![Public method](../icons/pubMethod.gif)| [GetMemberIds](42a745b8-dc2e-ef06-0ad3-7e4c775eea9d.htm)| Retrieves all the member ElementIds of the group.  
...
![Public method](../icons/pubMethod.gif)| [GetShownAttachedDetailGroupTypeIds](39290399-a9b1-52ed-cfcf-33c24b9b675c.htm)|  Returns the attached detail groups which have displayed instances for this group type in the input view.   
...
![Public method](../icons/pubMethod.gif)| [HideAllAttachedDetailGroups](df7937f2-c48b-8549-a7e2-f2fd1cbafa7b.htm)|  Hides all the available attached detail groups for this element group type that are compatible with the input view type.   
![Public method](../icons/pubMethod.gif)| [HideAttachedDetailGroups](660bd48f-dd60-562c-1935-8fcbd258669a.htm)|  Hides the element group's attached detail groups of the input group type that are compatible with the input view.   
![Public method](../icons/pubMethod.gif)| [IsCompatibleAttachedDetailGroupType](60562c31-ef34-4cbd-77bc-3fe89a8d2f38.htm)|  Checks if the orientation of the input attached detail group matches the input view's orientation.   
...
![Public method](../icons/pubMethod.gif)| [ShowAllAttachedDetailGroups](e6c7cae5-a513-e212-8139-20abf9f40ba1.htm)|  Shows all the available attached detail groups for this element group type that are compatible with the input view type.   
![Public method](../icons/pubMethod.gif)| [ShowAttachedDetailGroups](2e4d7640-92fa-fc3b-83a2-e492bc8b0269.htm)|  Shows the element group's attached detail groups of the input group type that are compatible with the input view.   
![Public method](../icons/pubMethod.gif)| ToString| Returns a string that represents the current object.(Inherited from Object)  
![Public method](../icons/pubMethod.gif)| [UngroupMembers](086b03c7-6a46-a825-1cae-9739a7819d4f.htm)| Ungroups the group.  
Top
