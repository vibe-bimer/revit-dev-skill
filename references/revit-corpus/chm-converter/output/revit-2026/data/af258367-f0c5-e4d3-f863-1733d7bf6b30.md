...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.htm) Autodesk.Revit.DB.StructureRebarCoupler
...
![Public property](../icons/pubProperty.gif)| [CouplerMark](8381cc59-9dff-664c-682b-84d0086f93c1.htm)|  gets and sets the coupler mark   
...
![Public property](../icons/pubProperty.gif)| [RotationAngle](8594c93b-b0a0-ef01-22b8-1574aa3a6634.htm)|  Indetifies the rotation angle of the coupler around its axis.   
...
![Public method](../icons/pubMethod.gif)| [CouplerLinkTwoBars](f9b71707-f877-c2a2-1297-a132766e0c53.htm)|  returns true if the coupler sits on two rebar and false otherwise   
![Public method](../icons/pubMethod.gif)![Static member](../icons/Static.gif)| [Create](52fc10f6-e5b0-0f47-20fa-90be57b48004.htm)|  Creates a new instance of a Rebar Coupler element within the project.   
...
![Public method](../icons/pubMethod.gif)| [GetCoupledReinforcementData](f6b701e8-73e3-3ca1-bb8b-c9bbea755be1.htm)|  gets the reinforcement data. The returned list will have size = 2. If coupler stays on only one bar one element in this list will be null.   
![Public method](../icons/pubMethod.gif)| [GetCouplerPositionTransform](78db7785-7069-4511-747e-ea0de2702e8d.htm)|  Return a transform representing the relative position of the coupler at index couplerPositionIndex in the set.   
![Public method](../icons/pubMethod.gif)| [GetCouplerQuantity](d9910074-138f-1d7a-3101-ed6a2ad3fc5b.htm)|  Identifies the number of couplers in a set.   
...
![Public method](../icons/pubMethod.gif)| [GetPointsForPlacement](c270a509-8e1d-8e13-2176-d3680045dbe4.htm)|  gets the point (or points in case of rebar set) where the coupler is placed   
...
![Public method](../icons/pubMethod.gif)| [IsUnobscuredInView](55abcef4-e64e-4582-2ca3-d10b27102477.htm)|  Checks if this rebar coupler element is shown unobscured in a view.   
...
![Public method](../icons/pubMethod.gif)| [SetUnobscuredInView](1e883463-46aa-feb3-1660-dc757dc722d3.htm)|  Sets this rebar coupler element to be shown unobscured in a view.   
