...
#### Return Value
[ChangeType](bf7c5e20-b639-da97-4586-4a0bc0010705.htm) ChangeType that can be used to define a trigger for an Updater, triggering on a geometry change in an element 
